                                    ...
                                    <div class="text-dark kt-form kt-form--label-right">
                                        ...
                                        <fieldset class="custom_fieldset">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="text" class="form-control" name="trip_id" placeholder="TRP@php (printf('%05d', $last_trip_id+1)) @endphp" readonly>
                                                    <small id="vehicle_type-error" class="text-danger"></small>
                                                </div>
                                                <label class="col-lg-2 col-form-label">Trip Generated Date</label>
                                                <div class="col-lg-4">
                                                    <input type="text" class="form-control" name="trip_id" value="{{date('d M Y h:i a', strtotime('+6 hour'))}}" readonly>
                                                    <small id="vehicle_type-error" class="text-danger"></small>
                                                </div>
                                            </div>
                                            <div class="form-group row ">
                                                    ...
                                                    <div class="tripSectionWrapper">
                                                        <div class="form-group row customFormGroup">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="row">
                                                                    <div class="col-lg-4"> <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                            <input type="radio" class="selectedTripDay_0" name="trip_day[][0]" value="single" checked>
                                                                            Single <span></span> </label>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <label class="kt-radio kt-radio--bold kt-radio--brand">
                                                                            <input type="radio" class="selectedTripDay_0" name="trip_day[][0]" value="multi">
                                                                            Multi
                                                                            <span></span> </label>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <label class="col-lg-2 col-form-label total_duration_label_0">Total
                                                                Day</label>
                                                            <div class="col-lg-4">
                                                                <input type="number" class="form-control" name="total_duration[]" id="total_duration_0" value="1" autocomplete="off" />
                                                        ...
                                                        <div class="form-group row customFormGroup">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <input type="text" class="form-control " name="contact_person_name[]" id="contact_person_name_0" autocomplete="off" placeholder="Enter contact person name" /> <small id="contact_person_name_0-error" class="text-danger"></small>
                                                            </div>

                                                            <label class="col-lg-2 col-form-label general_contact_person_phone_label_0">Contact Person Phone
                                                            </label>
                                                            <div class="col-lg-4">
                                                                <input type="text" class="form-control " name="contact_person_phone[]" id="contact_person_phone_0" autocomplete="off" placeholder="Enter contact person phone" /> <small id="contact_person_phone_0-error" class="text-danger"></small>
                                                            </div>
                                                            <label class="col-lg-2 col-form-label general_pickup_location_label_0">Pickup
                                                                Location</label>
                                                            <div class="col-lg-4">
                                                                <input type="text" class="form-control " name="pickup_location[]" id="pickup_location_0" autocomplete="off" placeholder="Enter pickup location" /> <small id="pickup_location_0-error" class="text-danger"></small>
                                                            </div>
                                                            <label class="col-lg-2 col-form-label general_drop_location_label_0">Drop
                                                                Location </label>
                                                            <div class="col-lg-4">
                                                                <input type="text" class="form-control " name="drop_location[]" id="drop_location_0" autocomplete="off" placeholder="Enter drop location" />
                                                            ...
                                                            <label class="col-lg-2 col-form-label general_pickup_datetime_label_0">Pickup
                                                                ...
                                                                Time</label>
                                                            <div class="col-lg-4">
                                                                <input type="text" class="form-control dateTimePicker" name="pickup_time[]" id="pickup_time_0" autocomplete="off" placeholder="Choose pickup date & time" />
                                                            ...
                                                            <label class="col-lg-2 col-form-label general_drop_datetime_label_0">Drop
                                                                ...
                                                                Time</label>
                                                            <div class="col-lg-4">
                                                                <input type="text" class="form-control dateTimePicker" name="drop_time[]" id="drop_time_0" autocomplete="off" placeholder="Choose drop date & time" />
                                                            ...
                                                            <div class="col-lg-4">
                                                                <textarea name="description[]" class="form-control" id="description_0" cols="30" rows="1" placeholder="Enter description"></textarea>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <input type="number" class="form-control trip_calculate_0" autocomplete="off" name="trip_rate[]" id="trip_rate_0" placeholder="Enter trip rate" />
                                                                <small id="trip_rate_0-error" class="text-danger"></small>
                                                            </div>

                                                            <label class="col-lg-2 col-form-label">Extra
                                                                Amount</label>
                                                            <div class="col-lg-4"> <input type="number" class="form-control trip_calculate_0" autocomplete="off" name="extra_amount[]" id="extra_amount_0" placeholder="Enter extra amount" />
                                                        ...
                                                        <div class="form-group row customFormGroup down_trip_rel_field_0 d-none">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <input type="text" class="form-control " name="down_contact_person_name[]" id="down_contact_person_name_0" autocomplete="off" placeholder="Enter contact person name" /> <small id="down_contact_person_name_0-error" class="text-danger"></small>
                                                            </div>

                                                            <label class="col-lg-2 col-form-label ">Down Contact Person Phone
                                                            </label>
                                                            <div class="col-lg-4">
                                                                <input type="text" class="form-control " name="down_contact_person_phone[]" id="down_contact_person_phone_0" autocomplete="off" placeholder="Enter contact person phone" /> <small id="down_contact_person_phone_0-error" class="text-danger"></small>
                                                            </div>
                                                            ...
                                                            <label class="col-lg-2 col-form-label ">Down
                                                                ...
                                                                Location</label>
                                                            <div class="col-lg-4 ">
                                                                <input type="text" class="form-control " name="down_pickup_location[]" id="down_pickup_location_0" autocomplete="off" placeholder="Enter pickup location" /> <small id="down_pickup_location_0-error" class="text-danger"></small>
                                                            </div>
                                                            <label class="col-lg-2 col-form-label ">Down
                                                                Drop Location </label>
                                                            <div class="col-lg-4 ">
                                                                <input type="text" class="form-control " name="down_drop_location[]" id="down_drop_location_0" autocomplete="off" placeholder="Enter drop location" />
                                                                <small id="down_drop_location_0-error" class="text-danger"></small>
                                                            </div>
                                                            <label class="col-lg-2 col-form-label ">Down
                                                                Pickup Date & Time</label>
                                                            <div class="col-lg-4 ">
                                                                <input type="text" class="form-control dateTimePicker" name="down_pickup_time[]" id="down_pickup_time_0" autocomplete="off" placeholder="Choose pickup date & time" />
                                                            ...
                                                            <div class="col-lg-4 ">
                                                                <input type="text" class="form-control dateTimePicker" name="down_drop_time[]" id="down_drop_time_0" autocomplete="off" placeholder="Choose drop date & time" />
                                                            ...
                                                            <div class="col-lg-4 ">
                                                                <textarea name="down_description[]" class="form-control" id="down_description_0" cols="30" rows="1" placeholder="Enter description"></textarea>
                                                            ...
                                                            <div class="col-lg-4 down_trip_rel_field_0 d-none">
                                                                <input type="number" class="form-control trip_calculate_0" autocomplete="off" name="down_trip_rate[]" id="down_trip_rate_0" placeholder="Enter trip rate" />
                                                                <small id="down_trip_rate_0-error" class="text-danger"></small>
                                                            </div>

                                                            <label class="col-lg-2 col-form-label">Extra
                                                                Amount</label>
                                                            <div class="col-lg-4"> <input type="number" class="form-control " autocomplete="off" name="down_extra_amount[]" id="down_extra_amount_0" placeholder="Enter extra amount" />
                                                        ...
                                                        <div class="form-group row customFormGroup">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-8"> <input type="text" class="form-control" autocomplete="off" name="total_amount[]" id="total_amount_0" readonly placeholder="Total amount" />
                                                                        <small id="total_amount_0-error" class="text-danger"></small>
                                                                    </div>
                                                                    <label class="col-lg-4 col-form-label">Discount
                                                                        Amount</label>
                                                                    <div class="col-lg-8"> <input type="number" class="form-control trip_calculate_0" autocomplete="off" name="discount_amount[]" id="discount_amount_0" placeholder="Enter discount amount" />
                                                                        <small id="discount_amount_0-error" class="text-danger"></small>
                                                                    </div>
                                                                    <label class="col-lg-4 col-form-label">Net Total
                                                                        Amount
                                                                    </label>
                                                                    <div class="col-lg-8"> <input type="text" class="form-control" autocomplete="off" name="net_total_amount[]" id="net_total_amount_0" readonly placeholder="Net total amount" />
                                                                        <small id="net_total_amount_0-error" class="text-danger"></small>
                                                                    </div>
                                                                    <label class="col-lg-4 col-form-label">Advance Paid
                                                                    </label>
                                                                    <div class="col-lg-8"> <input type="text" class="form-control" id="advance_paid_0" autocomplete="off" name="advance_paid[]" placeholder="Enter advance paid" />
                                                                        <small id="advance_paid_0-error" class="text-danger"></small>
                                                                    </div>
                                                                    <label class="col-lg-4 col-form-label">Due Amount
                                                                    </label>
                                                                    <div class="col-lg-8"> <input type="text" class="form-control" id="due_amount_0" name="due_amount[]" autocomplete="off" readonly placeholder="Due amount" />
                                                                    ...
                                                                    <div class="col-lg-8"> <input type="text" class="form-control" id="payment_status_0" name="payment_status[]" autocomplete="off" readonly placeholder="Payment Status" /> <small id="payment_status_0-error" class="text-danger"></small> </div>
                                                                    <label class="col-lg-4 col-form-label">Note </label>
                                                                    <div class="col-lg-8">
                                                                        <textarea name="note[]" class="form-control" id="note_0" cols="30" rows="2" placeholder="Enter note"></textarea>
                                                            ...
                                                            <tbody style="position:relative" id="tableBody">
                                                                <tr>
                                                                    ...
                                                                    <td class="select_option">
                                                                        <select class="form-control kt-select2-2  expense_type_list" name="expense_type[]" id="expense_type_0"></select>
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="form-control" name="expense_description[]">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="form-control text-center" name="expense_quantity[]" id="expense_quantity_0">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="form-control text-center" name="expense_cost[]" id="expense_cost_0">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="form-control text-center expense_total_amount" readonly name="expense_total[]" id="expense_total_0">
                                                                    </td>
                                                                    <td>
                                                                        <input type="text" class="form-control text-center expense_paid_amount" name="expense_paid[]" id="expense_paid_0">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
...
<script>
    $(document).ready(function() {
        ...
        expense_row_counter();
        fetchOptionList('#trip_type_0', 'master_settings', 'name', 'where type=16');
        fetchOptionList('#carrying_type_0', 'master_settings', 'name', 'where type=15');
        fetchOptionList('#trip_package_type_0', 'master_settings', 'name', 'where type=13');
        fetchOptionList('.expense_type_list', 'master_settings', 'name', 'where type=14');
        fetchOptionList('#payment_method_0', 'payment_method', 'method_name');
    ...
    function expense_calculation(idIndex) {
        ...
        var expense_net_total = 0;
        $('.expense_total_amount').each(function() {
            let totalAmount = ($(this).val()) ? $(this).val() : 0;
            expense_net_total = parseFloat(parseFloat(expense_net_total) + parseFloat(totalAmount)).toFixed(2);
        });

        var expense_net_paid = 0;
        $('.expense_paid_amount').each(function() {
            let paidAmount = ($(this).val()) ? $(this).val() : 0;
            expense_net_paid = parseFloat(parseFloat(expense_net_paid) + parseFloat(paidAmount)).toFixed(2);
        });

        let expense_due_balance = parseFloat(parseFloat(expense_net_total) - parseFloat(expense_net_paid)).toFixed(2);

        $('#net_expense_total').val(expense_net_total);
        $('#net_expense_paid').val(expense_net_paid);
        $('#expense_due_balance').text(expense_due_balance);

        if (expense_net_total > 0 && expense_net_paid == 0) {
            $('#expense_status').text('Full due');
        } else if (expense_net_total > 0 && expense_net_total == expense_net_paid) {
            $('#expense_status').text('Full paid');
        } else if (expense_net_total > 0 && expense_net_paid > 0 && expense_net_paid < expense_net_total) {
    ...
    function initTripRelatedFunction() {
        ...
        // $("input[class^=selectedTripDay_]").change(function() {
        //     let classIndex = $(this).attr('class').substr(16);
        //     if (this.value == 'single') {
        //         $('#single_trip_day_' + classIndex).removeClass('d-none');
        //         $('#multi_trip_day_' + classIndex).addClass('d-none');
        //     } else {
        //         $('#multi_trip_day_' + classIndex).removeClass('d-none');
        //         $('#single_trip_day_' + classIndex).addClass('d-none');
        //     }
        // });
