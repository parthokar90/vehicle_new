        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="" class="kt-subheader__breadcrumbs-link">Purchase Add</a>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group row">
                                    <label class="col-form-label col-md-3">Vendor Name</label>
                                    <div class="col-md-8 ">

                                        <select name="vendor_name" id="vendor_name" class="form-control kt-select2-2">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-3">Purchase Date</label>
                                    <div class="col-md-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-md-3">Purchase Status</label>
                                    <div class="col-md-8">
