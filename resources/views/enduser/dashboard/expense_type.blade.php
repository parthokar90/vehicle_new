        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="" class="kt-subheader__breadcrumbs-link">Expense Type</a>
                </div>
            </div>
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid driver_data_list">
        ...
        <div class="kt-portlet kt-portlet--height-fluid custom-kt-portlet--height-fluid">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable" id="expense_type_table">
                    <thead>
                        <tr>
                            <th width="30px">SL</th>
                            <th>Name</th>
            ...
            <form id="saveExpenseTypeForm">
                <div class="modal-body  text-dark">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Expense Group</label>
                        <div class="col-lg-9">
                            <select class="form-control kt-select2-2" name="expense_group">

                            </select>
                            <small id="expense_group-error" class="text-danger"></small>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Default Show</label>
                        <div class="col-lg-9">
                            <select class="form-control kt-select2-2" name="default_section">
                                <option value="1">Yes</option>
                                <option value="0">No</option>
                            </select>
                            <small id="default_section-error" class="text-danger"></small>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Default Group</label>
                        <div class="col-lg-9">
                            <select class="form-control kt-select2-2" name="default_group">

                            </select>
                            <small id="default_group-error" class="text-danger"></small>
                        </div>
                    </div>
                  
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Default Section</label>
                        <div class="col-lg-9">
                            <select class="form-control kt-select2-2" name="default_section">
...
function main_type_datalist() {
    var table = $('#expense_type_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
    ...
    table.buttons().container().appendTo('#expense_type_table_length');
}
...
$('#submitMainType').click(function(event) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#expense_type_table').DataTable().ajax.reload();
