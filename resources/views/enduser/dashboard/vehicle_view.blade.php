                            ...
                            <div class="kt-widget kt-widget--user-profile-1">
                                <div class="kt-widget__head">
                                    <div class="kt-widget__media">
                                        ...
                                        <img src="{{asset('public/uploads/vehicle/'.$vehicle->vehicle_photo)}}" alt="image">
                                        @else
                                        <img src="{{asset('assets/media/cars/private.jpg')}}" alt="image">
                                        @endif
                                    </div>
                                    <div class="kt-widget__content">
                                        <input type="hidden" id="vehicle_view_type" value="{{$type}}">
                                        <div class="kt-widget__section">
                                            <a href="javascript:;" class="kt-widget__username" id="show_vehicle_no" style="font-size:14px; color:#8e91a0; font-weight:bold;">{{$vehicle->vehicle_no}}
                                            </a>
                                        </div>
...
<script>
    ...
    function load_vehicle_info(page_name = null) {
        ...
        ).load("{{ url('dashboard/vehicle_info')}}/" + page_name + "/{{$vehicle->id}}");
    }
</script>