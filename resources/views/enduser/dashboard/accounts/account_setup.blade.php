        ...
        <div class="modal-content">
            ...
            <form id="saveCOAForm">
                <div class="modal-body  text-dark">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label">Group Name</label>
                        <div class="col-lg-8">
                            <select name="parent" id="parent" class="form-control kt-select2-2">
                                @php generate_custom_dropdown('chart_of_accounts','title','code_no,account_type,transactional'); @endphp
                            </select>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label">A/C Head Name</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="title" id="title" placeholder="Enter a/c head name">
                            <small id="title-error" class="text-danger"></small>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label">A/C Head ID</label>
                        <div class="col-lg-8">
                            <input type="text" class="form-control" name="code_no" id="code_no" placeholder="Enter a/c head ID">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <textarea class="form-control" name="description" cols="30" rows="2" id="description" placeholder="Enter description"></textarea>
                            <small id="description-error" class="text-danger"></small>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label">Transactional</label>
                        <div class="col-lg-8">
...
<script>
    ...
    $('#account_type').change(function(event) {
        ...
        var condition = "where parent_id=" + typeId;
    ...
    function edit_data(id) {
        ...
        $.ajax({
            url: "{{url('dashboard/account_setup_data')}}/" + id,
            type: "GET",
            // dataType: "json",
            success: function(data) {
    ...
    function account_setup_datatable() {
        var table = $('#account_setup_table').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "{{ url('dashboard/account_setup_datatable') }}",
                data: function(d) {
                    d._token = '{!! csrf_token() !!}';
                }
            },
    ...
    $('#saveCOAForm').submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ url('dashboard/save_account_setup_data')}}/" + id,
            ...
            success: function(response) {
                ...
                $('#coaModal').modal('hide');
                if (id > 0) {
                    successMsg('COA updated successfully.');
                    $('#account_setup_table').DataTable().ajax.reload(null, false);
                } else {
                    successMsg('COA created successfully.');
