...
<body>
    ...
    <div class="container">
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('dealer.login.submit') }}" id="loginFormSubmit" novalidate="novalidate" aria-label="{{ __('Login') }}">
                        @csrf
                        ...
                        <div class="row justify-content-between align-items-center remember">
                ...
                <div class="card-footer">
                    ...
                    <div class="d-flex justify-content-center links">
                        <a href="{{route('admin.login')}}">Login as system user</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <style>
        ...
        html,
        body {
            background-image: url("{{asset('assets/media/bg/police_back.jpg')}}");
        ...
        .card {
            /* background-image: url("{{asset('assets/media/bg/police_logo.png')}}");
            background-size: cover;
            background-repeat: no-repeat; */
            position: fixed;
            top:30%;
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if(response ==0){
                        ...
                        setTimeout(function(){
                            window.location.href = "{{route('enduser.monitor')}}"
                            }, 500);
                    }
                },
