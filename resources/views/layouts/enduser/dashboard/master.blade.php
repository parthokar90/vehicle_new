...
<head>
    ...
    <link href="{{asset('assets/css/enduser/vms-custom.css')}}" rel="stylesheet" />
...
<body
    ...
    <!-- begin:: Header -->
    @include('layouts.enduser.dashboard.navber')
    ...
    <script src="{{asset('assets/js/pages/scrollable.js')}}"></script>
    ...
    //         '<center><div style="position: absolute; left: 50%; top: 40%;"><img src={{asset("assets/images/loading.gif")}} style="width:130px; height:auto;"></div></center>'
    //     ).load("{{ url('dashboard/dashboard')}}/" + page_name);
    // }
