        ...
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
            ...
            <ul class="kt-menu__nav ">
                <!-- <li class="kt-menu__item  " aria-haspopup="true">
                    <a href="javascript:;" class="kt-menu__link  " id="dashboard" data-rel="dashboard">
                ...
                <li class="kt-menu__section custom-kt-menu__section">
                    <h4 class="kt-menu__section-text">Customer Overview</h4>
                    <i class="kt-menu__section-icon flaticon-more-v2"></i>
                </li>
                <li class="kt-menu__item" aria-haspopup="true">
                    <a href="{{url('dashboard/p/profile/profile_information')}}" class="kt-menu__link  " id="profile" data-rel="profile"
                        data-tab="profile_information">
                        <span class="kt-menu__link-icon">
                ...
                <li class="kt-menu__item" aria-haspopup="true"><a href="javascript:;" class="kt-menu__link "><span
                            ...
                            </svg></span><span class="kt-menu__link-text">My Task </span></a>
                </li>
                <li class="kt-menu__item  " aria-haspopup="true">
                    <a href="{{url('dashboard/p/complain')}}" class="kt-menu__link " id="complain" data-rel="complain">
                        <span class="kt-menu__link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li class="kt-menu__item  " aria-haspopup="true">
                    <a href="javascript:;" class="kt-menu__link ">
                        ...
                        <span class="kt-menu__link-text">Billing and Payment</span>
                    </a>
                </li>
                <li class="kt-menu__item" aria-haspopup="true">
                    <a href="{{url('dashboard/p/my_activities')}}" class="kt-menu__link " id="my_activities"
                        data-rel="my_activities">
                        <span class="kt-menu__link-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="kt-menu__link-text">My Activities</span>
                    </a>
                </li>
