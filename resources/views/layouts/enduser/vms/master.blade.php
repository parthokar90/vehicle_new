...
<html lang="en">
	...
	<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<!-- begin:: Page -->
			...
			<!-- begin:: Header -->
			@include('layouts.enduser.vms.navber')
		...
		<script>
			...
			$(document).ready(function(){
				...
				$(".vms_menu_item").each(function(index){
					$(this).on('click', function(e){
						...
						$(".kt-menu__item--submenu").not($(this)).parent().removeClass('kt-menu__item--open');
			...
			function load_vms_page(page_name=null){
				$("#load_vms_content").load("{{ url('dashboard/vms')}}/"+page_name);
			}
