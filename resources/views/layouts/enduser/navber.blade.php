...
<div class="kt-grid kt-grid--hor kt-grid--root">
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
        ...
        @include('layouts.enduser.sideber')
        <!-- end:: Aside -->
                    ...
                    <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item kt-menu__item--active">
                                <a href="{{route('enduser.dashboard')}}" class="kt-menu__link">
                                    <span class="kt-menu__link-text">Home</span>
                                </a>
                            </li>
                            <li class="kt-menu__item ">
                                <a href="{{route('enduser.report')}}" class="kt-menu__link">
                                    <span class="kt-menu__link-text">Report</span>
                                </a>
                            </li>
                            <li class="kt-menu__item  ">
                                <a  class="kt-menu__link" href="{{route('enduser.monitor')}}">
                        ...
                        <form method="get" class="kt-quick-search__form custom-search-form">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <input type="submit" class="btn btn-info custom-info btn-sm" value="Divce">
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                            ...
                            <div class="kt-notification">
                                <a href="{{url('dashboard/dashboard?page_type=profile')}}" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
                                ...
                                <a href="{{url('dashboard/dashboard?page_type=my_activities')}}" class="kt-notification__item">
                                    <div class="kt-notification__item-icon">
