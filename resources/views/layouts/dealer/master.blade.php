...
<head>
    ...
    <link href="{{asset('assets/css/business/dealer-custom.css')}}" rel="stylesheet" />
...
<body
    ...
    <!-- <div id="show_device_loader" class="col-sm-12 text-center d-none" style="position: absolute; left: 0%; display: flex; align-items: center; justify-content: center; z-index: 99999;">
    ...
    <!-- Modals -->
    <div class="modal fade" id="addSmsModal" data-backdrop="static" data-keyboard="false">
    ...
    $(document).ready(function() {
        $(".dealer_home_menu_item").each(function(index) {
            $(this).on('click', function(e) {
                e.preventDefault();
                if ($(this).data('rel') == 'profile') {
                    load_home_page($(this).data('rel'), $(this).data('tab'));
                } else {
                    load_home_page($(this).data('rel'));
                }
                $(".dealer_home_menu_item").not($(this)).parent().removeClass(
                    'kt-menu__item--active');
