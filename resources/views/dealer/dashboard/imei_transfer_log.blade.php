    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet kt-portlet--height-fluid custom-kt-portlet--height-fluid">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            <a href="#imeiModal" data-toggle='modal' class=" add_imei btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable" id="dealer_imei_transfer_log_table">
                    <thead>
                        <tr>
                        <th>SL</th>
                        <th>Date</th>
...
<script>
    $(function() {
        // var id = 0;
        var table = $('#dealer_imei_transfer_log_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                type: "GET",
                url: "{{url('dealer/imei/getLogData')}}",
                data: function(d) {
                    d._token = '{!! csrf_token() !!}';
                }
            },
        ...
        table.buttons().container().appendTo('#dealer_imei_transfer_log_table_length');
