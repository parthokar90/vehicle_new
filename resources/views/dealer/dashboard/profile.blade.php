                        ...
                        <div class="kt-widget kt-widget--user-profile-1">
                            ...
                            <div class="kt-widget__body">
                                ...
                                <div class="kt-widget__items">
                                    ...
                                    <a href="javascript:;" id="change_pro_pic" class="kt-widget__item profile_menu_item"
                                        data-rel="change_pro_pic">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                    ...
                                    <a href="javascript:;" id="branding_and_ui"
                                        class="kt-widget__item profile_menu_item" data-rel="branding_and_ui">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                                <i class="fas fa-assistive-listening-systems"></i></span>
                                            <span class="kt-widget__desc">
                                    ...
                                    <a href="javascript:;" id="change_password"
                            ...
                            <div class="kt-section kt-section--first">
                                <div class="kt-section__body">
                                    ...
                                    <div class="form-group form-group-last row">
                                        ...
                                        <div class="col-lg-9 col-xl-6">
                                            <div class="input-group">
                                                <input name="password_confirmation" id="password_confirm"
                        ...
                        <div class="kt-portlet__foot">
                            <div class="kt-form__actions">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        <button type="reset" class="btn btn-danger btn-sm">Reset</button>
                                        <input type="submit" class="btn btn-brand btn-sm float-right"
                                            value="Save Change">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-4">
                                        <form class="kt-form" id="light_logo_form">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="kt-avatar kt-avatar--outline kt-avatar--circle">
                                                    <div>
                                                        @if($profile->company_light_logo)
                                                        <img class="light_logo_holder custom_img_holder"
                                                            src="{{asset('public/uploads/user/logos/'.$profile->company_light_logo)}}"
                                                            alt="image">
                                                        @else
                                                        <img class="light_logo_holder custom_img_holder"
                                                            src="{{asset('assets/media/logos/crm-logo-2.png')}}"
                                                            alt="image">
                                                        @endif
                                                    </div>
                                                    <label class="kt-avatar__upload" data-toggle="kt-tooltip" title=""
                                    ...
                                    <div class="col-4">
                                        <form class="kt-form" id="dark_logo_form">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="kt-avatar kt-avatar--outline kt-avatar--circle">
                                                    <div>
                                                        @if($profile->company_dark_logo)
                                                        <img class="dark_logo_holder custom_img_holder"
                                                            src="{{asset('public/uploads/user/logos/'.$profile->company_dark_logo)}}"
                                                            alt="image">
                                                        @else
                                                        <img class="dark_logo_holder custom_img_holder"
                                                            src="{{asset('assets/media/logos/crm-logo-black-2.png')}}"
                                                            alt="image">
                                                        @endif
                                                    </div>
                                                    <label class="kt-avatar__upload" data-toggle="kt-tooltip" title=""
                                                ...
                                                <div class="kt-avatar kt-avatar--outline kt-avatar--circle">
                                                    <div>
                                                        ...
                                                        <img class="favicon_holder custom_img_holder"
                                                            src="{{asset('public/uploads/user/logos/'.$profile->favicon)}}"
                                                            alt="image">
                                                        @else
                                                        <img class="favicon_holder custom_img_holder"
...
$('#changePass').submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "{{ url('dealer/change-info/password') }}",
        data: $('#changePass').serialize(),
        success: function(response) {
            successMsg('Password updated successfully.');
            load_home_page('profile', 'change_password');
        },
...
$(document).ready(function(e) {
    ...
    $('#user_image').change(function() {
        ...
        reader.onload = (e) => {
            $('.user_avatar__holder').attr('src', e.target.result);
        }
...
$('#edit-profile-form').submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "{{  url('dealer/change-info/photo') }}",
        ...
        success: function(response) {
            ...
            load_home_page('profile', 'change_pro_pic');
        },
        error: function(reject) {
...
$('#light_logo_form').submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "{{  url('dealer/branding-info/company_light_logo') }}",
        data: new FormData(this),
        contentType: false,
        cache: false,
        processData: false,
        success: function(response) {
            ...
            load_home_page('profile', 'branding_and_ui');
        },
        error: function(reject) {
            errorMsg();
            if (reject.status === 422 || reject.status === 403) {
...
$('#dark_logo_form').submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "{{  url('dealer/branding-info/company_dark_logo') }}",
        data: new FormData(this),
        contentType: false,
        cache: false,
        processData: false,
...
//         type: "POST",
//         dataType: "json",
//         url: "{{  url('dealer/branding-info/favicon') }}",
//         data: new FormData(this),
//         contentType: false,
//         cache: false,
//         processData: false,
