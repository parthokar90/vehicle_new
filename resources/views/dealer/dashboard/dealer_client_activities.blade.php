    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--height-fluid custom-kt-portlet--height-fluid">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable" id="dealer_client_activities_table">
                    <thead>
                        <tr>
                        <th>SL</th>
                        <th>Date & Time</th>
...
<script>
    ...
    $(function() {
        // var id = 0;
        var table = $('#dealer_client_activities_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                type: "GET",
                url: "{{url('dealer/clientActivityDataList')}}",
                data: function(d) {
                    d._token = '{!! csrf_token() !!}';
                }
            },
        ...
        table.buttons().container().appendTo('#dealer_client_activities_table_length');
