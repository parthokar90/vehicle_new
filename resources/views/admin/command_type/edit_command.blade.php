...
<div class="modal-header bg-info">
    <h4 class="modal-title" id="edit_device_title"> Update Command Type</h4>
...
<!-- Modal Header -->
<div class="modal-header bg-info">
    <h4 class="modal-title" id="edit_device_title"> Add Command Type</h4>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
