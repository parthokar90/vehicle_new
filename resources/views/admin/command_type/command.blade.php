        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="" class="kt-subheader__breadcrumbs-link">Command Types</a>
                </div>
            </div>
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            <a href="#javascript:;"  class=" add_command btn btn-brand btn-elevate btn-icon-sm">
...
<script>
    ...
    function load_table() {
        ...
        var table = $('#command_table').DataTable({
            ...
            ajax: {
                type: "GET",
                url: "{{url('admin/command/getData')}}/0/" + id,
                data: function(d) {
                    d._token = '{!! csrf_token() !!}';
                }
            },
    ...
    $(function() {
        ...
        $('.add_command').click(function(e) {
            e.preventDefault();
            var id = 0;
            $('#load_modal_content').load('{{url("admin/command/add_edit_data")}}/' + id );
