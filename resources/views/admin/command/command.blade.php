        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="" class="kt-subheader__breadcrumbs-link">Commands</a>
                </div>
            </div>
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--height-fluid custom-kt-portlet--height-fluid">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            <a href="#imeiModal" data-toggle='modal' class=" add_command btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable" id="command_table">
                    <thead>
                        <tr>
                            <th>SL</th>
                            <th>Model</th>
...
<script>
    ...
    function load_table() {
        var id = 0;
        var table = $('#command_table').DataTable({
            destroy: true,
            processing: true,
            serverSide: true,
            ajax: {
                type: "GET",
                url: "{{url('admin/command/getData')}}/" + id,
                data: function(d) {
                    d._token = '{!! csrf_token() !!}';
                }
            },
        ...
        table.buttons().container().appendTo('#command_table_length');
    }

    $(function() {

        $('.add_command').click(function(e) {
            e.preventDefault();
            var id = 0;
            $('#load_modal_content').load('{{url("admin/command/edit_data")}}/' + id );
    ...
    function save_data(id) {
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "{{ url('admin/command/saveData') }}",
            data: {
                'id':id,
            ...
            success: function(response) {
                if (response == 1) {
                    successMsg('Command added successfully');
