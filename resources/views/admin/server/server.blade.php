                    ...
                    <div class="col-md-12">
                        <div class="card custom-card"  style="background-image: url('{{asset("assets/media/misc/bg-1.jpg")}}')">
                            <div class="card-body custom-card-body">
                                <h5 class="card-title text-center"></i>Total Server</h5>
    ...
    $(function () {
        ...
        var table= $('#server_table').DataTable({
            ...
            columns: [
                ...
                {data: 'hosting_realip', name: 'hosting_realip', className: 'text-center'},
                {data: 'hosting_url', name: 'hosting_url'},
