        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="" class="kt-subheader__breadcrumbs-link"> System Admin Login History</a>
                </div>
            </div>
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--height-fluid custom-kt-portlet--height-fluid">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable" id="admin_login_history_table">
                    <thead>
                        <tr>
                        <th>SL</th>
                        <th>Date & Time</th>
...
<script>
    ...
    $(function() {
        // var id = 0;
        var table = $('#admin_login_history_table').DataTable({
            // processing: true,
            // serverSide: true,
            // ajax: {
            //     type: "GET",
        ...
        table.buttons().container().appendTo('#admin_login_history_table_length');
