    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet kt-portlet--height-fluid custom-kt-portlet--height-fluid">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable" id="tu_status_log_table">
                    <thead>
                        <tr>
...
$(function() {
    ...
    var table = $('#tu_status_log_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            type: "GET",
            url: "{{ url('tu_status_log') }}",
            data: function(d) {
                d._token = '{!! csrf_token() !!}';
            }
        },
    ...
    table.buttons().container().appendTo('#tu_status_log_table_length');
