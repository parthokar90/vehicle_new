                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            <a href="#roleModal" data-toggle='modal' class=" add_role btn btn-brand btn-sm btn-elevate btn-icon-sm">
...
<!-- Modals -->
<div class="modal fade" id="roleModal" data-backdrop="static" data-keyboard="false">
...
<script>
    ...
    $(function () {      
        ...
        table.buttons().container().appendTo('#role_table_length');
