    ...
    <div class="modal-body">
        ...
        <div class=" row form-group">
            ...
            <div class="col-lg-9 col-xl-6">
                <span class="form-control">{{$usergroup->name}}</span>
            </div>
        </div> 
        <div class="row form-group">
            <label for="email" class="col-3 col-form-label">Description</label>
            <div class="col-lg-9 col-xl-6">
                <span class="form-control">{{$usergroup->description}}</span>
            </div>
        </div>
        <div class="row form-group">
