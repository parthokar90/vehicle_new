    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-grid kt-grid--desktop kt-grid--ver kt-grid--ver-desktop kt-app">
                        ...
                        <div class="kt-widget kt-widget--user-profile-1">
                            ...
                            <div class="kt-widget__body">
                                ...
                                <div class="kt-widget__items">
                                    ...
                                    <a href="javascript:;" class="kt-widget__item kt-widget__item--active profile_menu_item" data-rel="change-info">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <a href="#" id="change_password" class="kt-widget__item profile_menu_item" data-rel="change-password">
                                        <span class="kt-widget__section">
                                            <span class="kt-widget__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-app__content">
                <div class="row" id="profile_info_pages">
                    <!-- dynamic content -->
                </div>
            </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#profile_info_pages").load("{{ url('profiles/change-info')}}");
    });

    function load_profile_page(page_name=null){
        $("#profile_info_pages").load("{{ url('profiles')}}/"+page_name);
    }
</script>
@endsection