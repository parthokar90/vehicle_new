        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="" class="kt-subheader__breadcrumbs-link">Sensor</a>
                </div>
            </div>
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--height-fluid custom-kt-portlet--height-fluid">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            <!-- <a href="#javascript:;"  class=" add_notification btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable" id="sensor_master_table">
                    <thead>
                        <tr>
                            <th>SL</th>
                            <th>Category</th>
...
<script>
    ...
    function load_table() {
        var id = 0;
        var table = $('#sensor_master_table').DataTable({
            destroy: true,
            processing: true,
            serverSide: true,
            ajax: {
                type: "GET",
                url: "{{url('admin/sensor_master/getData')}}/0/" + id,
                data: function(d) {
                    d._token = '{!! csrf_token() !!}';
                }
            },
        ...
        table.buttons().container().appendTo('#sensor_master_table_length');
    }
    ...
    //         e.preventDefault();
    //         var id = 0;
    //         $('#load_modal_content').load('{{url("admin/sensor_master/edit_data")}}/' + id );
    ...
    //             if (response == 1) {
    //                 successMsg('Notification added successfully');
    //                 $("#add_update_modal").modal('hide');
    //                 // load_table();
    //                 $('#sensor_master_table').DataTable().ajax.reload(null, false);
