        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <span class="kt-subheader__breadcrumbs-separator"></span>
                    <a href="" class="kt-subheader__breadcrumbs-link">Notifications</a>
                </div>
            </div>
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="kt-portlet kt-portlet--height-fluid custom-kt-portlet--height-fluid">
            ...
            <div class="kt-portlet__body">
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable" id="notification_table">
                    <thead>
                        <tr>
                            <th>SL</th>
                            <th>Category</th>
...
<script>
    ...
    function load_table() {
        ...
        var table = $('#notification_table').DataTable({
            ...
            ajax: {
                type: "GET",
                url: "{{url('admin/notification/getData')}}/0/" + id,
                data: function(d) {
                    d._token = '{!! csrf_token() !!}';
                }
            },
        ...
        table.buttons().container().appendTo('#notification_table_length');
    }
    ...
    $(function() {
        ...
        $('.add_notification').click(function(e) {
            e.preventDefault();
            var id = 0;
            $('#load_modal_content').load('{{url("admin/notification/edit_data")}}/' + id );
