...
<head>
    ...
    #gauge {
        ...
        position: relative;
        height: 190px;
        background:url("{{asset('assets/images/speedometer_back.png')}}") no-repeat;
    }
    ...
    #circle {
        width: 79px;
        height: 79px;
        background: url("{{asset('assets/images/speedo_circle_1.png')}}")no-repeat;
        bottom: 45px;
        left: 68px;
        position: absolute;
    }
    ...
    #circle_2 {
        width: 79px;
        height: 79px;
        background: url("{{asset('assets/images/speedo_circle_2.png')}}")no-repeat;
        bottom: 39px;
        left: 74px;
        position: absolute;
        z-index: 9999999;
                ...
                <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                    <div class="kt-aside__brand-logo">
                        <a href="{{route('enduser.dashboard')}}">
                            @if(Auth::user()->company_dark_logo)
                            <img src="{{asset('uploads/user/logos/'.Auth::user()->company_dark_logo)}}"
                                alt="Logo" style="height:40px">
                            @else
                            <img alt="Logo" src="{{asset('assets/media/logos/crm-logo-black-2.png')}}"
                                style="height:40px" />
                            @endif
                        </a>
                    </div>
                                                                            ...
                                                                            <ul class="kt-nav custom-onclick-option">
                                                                                <li class="kt-nav__item">
                                                                                    <a href="javascript:;"
                                                                                        ...
                                                                                        class="kt-nav__link">
                                                                                        <img src="{{asset('assets/media/icons/detail.png')}}"
                                                                                            alt="">
                                                                                        <span
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="{{url('dashboard/playback')}}/@{{all_d.imei}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="{{asset('assets/media/icons/playback.png')}}"
                                                                                            alt="">
                                                                                        <span
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="{{url('dashboard/report?report_type=quick&report_name=trip_report&imei=')}}@{{all_d.imei}}_@{{all_d.device_name}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="{{asset('assets/media/icons/report.png')}}"
                                                                                            alt="">
                                                                                        <span
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="javascript:;"
                                                                                        ...
                                                                                        class="kt-nav__link">
                                                                                        <img src="{{asset('assets/media/icons/command.png')}}"
                                                                                            alt="">
                                                                                        <span
                                                                    ...
                                                                    <span>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <ul class="kt-nav custom-onclick-option">
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="{{url('dashboard/playback')}}/@{{online.imei}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="{{asset('assets/media/icons/playback.png')}}"
                                                                                            alt="">
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="{{url('dashboard/report?report_type=quick&report_name=trip_report&imei=')}}@{{online.imei}}_@{{online.device_name}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="{{asset('assets/media/icons/report.png')}}"
                                                                                            alt="">
                                                                    ...
                                                                    <span>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <ul class="kt-nav custom-onclick-option">
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="{{url('dashboard/playback')}}/@{{offline.imei}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="{{asset('assets/media/icons/playback.png')}}"
                                                                                            alt="">
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="{{url('dashboard/report?report_type=quick&report_name=trip_report&imei=')}}@{{offline.imei}}_@{{offline.device_name}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="{{asset('assets/media/icons/report.png')}}"
                                                                                            alt="">
    ...
    app.controller('monitorCtrl', function($scope, $http, $window, $interval, $timeout) {
        angular.element(document).ready(function() {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: "{{URL::to('/dashboard/showTree')}}/" + @php echo $customer_id;@endphp,
        ...
        var battery_on_icon = "{{asset('assets/images/battery_on_icon.png')}}";
        var battery_off_icon = "{{asset('assets/images/battery_off_icon.png')}}";
        var engine_on_icon = "{{asset('assets/images/engine_on_icon.png')}}";
        var engine_off_icon = "{{asset('assets/images/engine_off_icon.png')}}";
        var fuel_on_icon = "{{asset('assets/images/fuel_on_icon.png')}}";
        var fuel_off_icon = "{{asset('assets/images/fuel_off_icon.png')}}";
        ...
        function device_event_data(imei) {
            $.ajax({
                type: "GET",
                dataType: "html",
                url: "{{url('dashboard/getDeviceEventData')}}/" + imei,
                success: function(response) {
        ...
        function driver_data(id) {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: "{{url('dashboard/getDriverDataByImie')}}/" + id,
                success: function(response) {
                    console.log(response);
                    if (response == 0) {
                        $('.DriverDataPart').addClass('d-none');
        ...
        function driving_behaviour(imei, device_name) {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "{{url('dashboard/showreport/drivingbehaviour/2')}}",
                data: {
                    device_list: imei_and_name,
                    from_monitor: true,
                    _token: "{{ csrf_token() }}",
        ...
        $scope.show_event_list = function() {
            load_spinner('show', 'show_loader', '');
            $http.get("{{url('dashboard/getEventList')}}/" + @php echo $customer_id; @endphp).then(function(
                response) {
        ...
        $scope.show_geofence_list = function() {
            load_spinner('show', 'show_loader', '');
            $http.get("{{url('dashboard/getGeofenceList')}}/" + @php echo $customer_id; @endphp).then(
                function(response) {
        ...
        $scope.go_to_geofence = function() {
            ...
            window.open("{{url('dashboard/geofence')}}", '_blank');
        }

        $("body").on('click', '.load_geo_address', function() {
            var address_div = $(this).parent();
            address_div.html('Loading...');
            $.get("{{url('dashboard/findAddress')}}/" + $(this).data('lat') + "/" + $(this).data('lng'))
                .done(function(res) {
