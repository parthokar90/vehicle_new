...
function menuEditor(idSelector, settings){
    ...
    $('#btnOut').on('click', function() {
        ...
        var url = $('#urlForMenu').val();
        var redirectUrl = $('#urlForRedirect').val();
    ...
    function addItem() {
        ...
        var module = $("#mnu_module").val();
        var btnEdit = TButton({classCss: 'btn btn-brand btn-sm btnEdit', text: labelEdit});
        // var btnRemv = TButton({classCss: 'btn btn-danger btn-sm btnRemove', text: labelRemove});
        var grpBtns = $("<div>").addClass('btn-group pull-right').append(btnEdit);
        var textItem = $('<span>').addClass('txt').text(text);
        var iconItem = $('<i>').addClass( $("#mnu_icons").val());
    ...
    function editItem(item) {
        $("#portletHeadTitle").text("Edit Menu");
    ...
    function updateItem() {
        ...
        var icon = $("#mnu_icons").val();
        itemEdit.children().children('i').removeClass(itemEdit.data('icons')).addClass(icon);
        ...
        itemEdit.data('module_id', $("#mnu_module_id").val());
        itemEdit.data('status', $("#mnu_status").val());
        itemEdit.data('icons', $("#mnu_icons").val());
        reset();
    ...
    function reset(){
        $("#frmEdit")[0].reset();
        $("#portletHeadTitle").text("Add Menu");
    ...
    * */
    function createMenu(arrayItem, depth){
        ...
        $.each(arrayItem, function(k, v){
            ...
            var $btnEdit = TButton({classCss: 'btn btn-default btn-sm btnEdit', text: labelEdit});
            var $btnRemv = TButton({classCss: 'btn btn-danger btn-sm btnRemove', text: labelRemove});
