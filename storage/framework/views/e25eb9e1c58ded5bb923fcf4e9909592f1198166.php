                ...
                <form id="saveComplainForm">
                    <div class="text-dark kt-form kt-form--label-right">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" name="generated_date" value="<?php echo e(date('d M Y h:i', strtotime('+6 hour'))); ?>" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                                <select name="complain_sector" id="complain_sector" class="form-control kt-select2-2">
                                    ...
                                    <?php if($m->assigned_id < 5 || $m->assigned_id > 9): ?>
                                        <option value="<?php echo e($m->assigned_id); ?>"><?php echo e($m->name); ?></option>
                                        <?php endif; ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                                <select name="reporter" id="reporter" class="form-control kt-select2-2">
                                    <?php echo e(generate_simple_dropdown('users','name')); ?>
    ...
    $("#complain_sector").change(function() {
        ...
        if (this.value > 0) {
            ...
            $.ajax({
                type: "POST",
                dataType: "html",
                url: "<?php echo e(url('dashboard/commonFunction')); ?>",
                data: {
                    table: table,
                    column: column,
                    condition: condition,
    ...
    $('#saveComplainForm').submit(function(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                window.location.href = "<?php echo e(url('dashboard/d/complain_add')); ?>";
            },
            error: function(reject) {
                errorMsg();
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/enduser/dashboard/complain_add.blade.php ENDPATH**/ ?>