                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 py-3">
                                    <select class="form-control kt-select2-employee" id="employee_list">
                                        <?php generate_simple_dropdown('users', 'name') ?>
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vehicle_new\resources\views/enduser/dashboard/customer.blade.php ENDPATH**/ ?>