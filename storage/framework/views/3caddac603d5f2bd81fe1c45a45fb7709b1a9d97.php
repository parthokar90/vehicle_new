...
<script>
    ...
    $(function () {      
        ...
        var table= $('#user_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('department.index')); ?>",
                data: function (d) {
    ...
    function edit_data(id){
        $.ajax({
            url: "<?php echo e(route('department.index')); ?>/"+id+"/edit",
            type: "GET",
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/enduser/department/index.blade.php ENDPATH**/ ?>