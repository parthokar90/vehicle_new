                            ...
                            <div class="kt-widget kt-widget--user-profile-1">
                                <div class="kt-widget__head">
                                    <div class="kt-widget__media">
                                        ...
                                        <img src="<?php echo e(asset('public/uploads/vehicle/'.$customer->vehicle_photo)); ?>"
                                            alt="image">
                                        <?php else: ?>
                                    ...
                                    <div class="kt-widget__content">
                                        ...
                                        <div class="kt-widget__section">
                                            <a href="javascript:;" class="kt-widget__username" id="show_vehicle_no" style="font-size:14px; color:#8e91a0; font-weight:bold;"><?php echo e($customer->customer_name); ?>
...
function load_customer_info(page_name = null) {
    ...
    ).load("<?php echo e(url('dashboard/customer_info')); ?>/" + page_name + "/<?php echo e($customer->id); ?>");
}
</script><?php /**PATH C:\xampp\htdocs\vehicle_new\resources\views/enduser/dashboard/customer_view.blade.php ENDPATH**/ ?>