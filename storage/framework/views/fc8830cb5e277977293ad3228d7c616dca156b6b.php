                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-5 col-md-9 col-sm-12">
                                                            <select class="form-control kt-select2-2"
                                                                name="vendor_type">
                                                                <option value="">Select</option>
                                                                <?php $__currentLoopData = $vendorType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$(document).ready(function() {
    ...
    $('#saveVendorForm').submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(url('dashboard/saveVendor')); ?>/" + id,
            data: $('#saveVendorForm').serialize(),
            success: function(response) {
                successMsg('Vendor created successfully.');
                window.location.href = "<?php echo e(url('dashboard/d/vendor_add')); ?>";
            },
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/enduser/dashboard/vendor_add.blade.php ENDPATH**/ ?>