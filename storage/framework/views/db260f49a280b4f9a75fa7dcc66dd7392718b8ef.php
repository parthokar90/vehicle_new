...
function doc_datatable() {
    var table = $('#document_table').DataTable({
        ...
        ajax: {
            type: "POST",
            url: "<?php echo e(url('dashboard/documentDatatable')); ?>",
            data: {
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/enduser/dashboard/document.blade.php ENDPATH**/ ?>