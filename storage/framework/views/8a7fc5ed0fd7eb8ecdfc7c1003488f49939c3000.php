...
<script>
    ...
    $(function() {
        ...
        var table = $('#inspection_table').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "<?php echo e(url('dashboard/vehicle_wise_datatable/inspection/'.$vehicle_id)); ?>",
                data: function(d) {
    ...
    function check_inspection(id) {
        ...
        $.ajax({
            type: "html",
            url: "<?php echo e(url('dashboard/vehicle_insp_check')); ?>",
            type: "POST",
            data: {
                inspection_id: id,
                vehicle_id: '<?php echo e($vehicle_id); ?>',
...
</script><?php /**PATH C:\xampp\htdocs\vehicle_new\resources\views/enduser/dashboard/vehicle/inspection.blade.php ENDPATH**/ ?>