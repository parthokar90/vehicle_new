...
function main_datatable() {
    var table = $('#maintenance_table').DataTable({
        ...
        ajax: {
            type: "POST",
            url: "<?php echo e(url('dashboard/maintenanceDatatable')); ?>",
            data: {
...
function view_data(id) {
    ...
    $("#load_content").load("<?php echo e(url('dashboard/driver-detail')); ?>/" + id);
}
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/enduser/dashboard/maintenance.blade.php ENDPATH**/ ?>