            ...
            <form id="saveAssignStaffForm">
                <div class="modal-body  text-dark">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="hidden" id="assign_to_vehicle_id" value="<?php echo e($vehicle_id); ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select class="mt-multiselect btn btn-default mt-noicon" multiple="multiple" data-clickable-groups="true" data-collapse-groups="true" data-width="100%" id="selected_staff">
                                <?php echo e(generate_staff_dropdown_by_type_group($vehicle_id)); ?>
...
<script>
    ...
    $(function() {
        ...
        var table = $('#vehicle_staff_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(url('dashboard/vehicle_wise_datatable/vehicle_staff/'.$vehicle_id)); ?>",
                data: function(d) {
    ...
    $('#saveAssignStaffForm').submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(url('dashboard/vehicle-assign-staff')); ?>/" + id,
            data: {
                id: id,
...
</script><?php /**PATH C:\xampp\htdocs\vehicle_new\resources\views/enduser/dashboard/vehicle/vehicle_staff.blade.php ENDPATH**/ ?>