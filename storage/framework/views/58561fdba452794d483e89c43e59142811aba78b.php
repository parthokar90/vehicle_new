...
<head>
    ...
    <link href="<?php echo e(asset('assets/css/global/custom.css')); ?>" rel="stylesheet" />
...
<body
    ...
    <!-- begin:: Header -->
    <?php echo $__env->make('layouts.admin.navber', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <!-- begin::Quick Panel -->
    <?php echo $__env->make('layouts.admin.quickpanel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- end::Quick Panel -->
    ...
    <!-- begin::Demo Panel -->
    <?php echo $__env->make('layouts.admin.demopanel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- end::Demo Panel -->

    <!--Begin:: Chat-->
    <?php echo $__env->make('layouts.admin.chat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--ENd:: Chat-->
    ...
    <script src="<?php echo e(asset('assets/js/pages/bootstrap-daterangepicker.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/layouts/admin/master.blade.php ENDPATH**/ ?>