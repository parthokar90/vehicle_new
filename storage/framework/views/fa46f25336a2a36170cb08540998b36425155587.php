    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid vehicle_data_list">
        ...
        <div class="kt-portlet kt-portlet--height-fluid custom-kt-portlet--height-fluid">
            ...
            <div class="kt-portlet__body">
                <form id="saveEmailSetting" action="<?php echo e(route('sms.settings.update',$user->id)); ?>" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" name="provider_name"
                                    placeholder="SMS Provider Name" value="<?php echo e($user->provider_name); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" name="user_id"
                                    placeholder="User id" value="<?php echo e($user->user_id); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                                <select name="status" class="form-control kt-select2-2">
                                    <option value="YES" <?php if($user->status=='YES'): ?> selected <?php endif; ?>>
                                        YES</option>
                                        <option value="NO" <?php if($user->status=='NO'): ?> selected <?php endif; ?>>
                                        NO</option>
                                </select>
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vehicle_new\resources\views/enduser/settings/sms/edit.blade.php ENDPATH**/ ?>