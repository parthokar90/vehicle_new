                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12 py-3">
                                    <select class="form-control kt-select2-2" name="global_status"
                                        ...
                                        <?php generate_simple_dropdown('combo_data', 'name', 'type=1') ?>

                                    </select>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 py-3">
                                    <select class="form-control kt-select2-vendor" id="vendor_type_list">
                                        <?php generate_simple_dropdown('master_settings', 'name', 'type=9') ?>

                                    </select>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 py-3">
                                    <select class="form-control kt-select2-district" name="district" id="district_list">
                                        <?php generate_simple_dropdown('districts', 'name') ?>
...
function load_vendor_table() {
    var table = $('#vendor_table').DataTable({
        ...
        ajax: {
            type: "POST",
            url: "<?php echo e(url('dashboard/vendor_datalist')); ?>",
            data: {
...
function view_data(id) {
    ...
    $("#load_content").load("<?php echo e(url('dashboard/vendor_detail')); ?>/" + id);
}
</script>
<script src="<?php echo e(asset('assets/js/business/jstree.bundle.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vehicle_new\resources\views/enduser/dashboard/vendor_manage.blade.php ENDPATH**/ ?>