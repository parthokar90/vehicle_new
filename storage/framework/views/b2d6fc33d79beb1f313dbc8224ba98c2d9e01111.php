...
<head>
    ...
    <link href="<?php echo e(asset('assets/css/optional/bootstrap-multiselect.css')); ?>" rel="stylesheet" />
    ...
    <link href="<?php echo e(asset('assets/css/enduser/vms-custom.css')); ?>" rel="stylesheet" />
...
<body
    ...
    <!-- begin:: Header -->
    <?php echo $__env->make('layouts.enduser.dashboard.navber', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <!-- end:: Header -->

    <?php echo $__env->yieldContent('content'); ?>

    <!-- <div id="load_vms_content">
    ...
    <script src="<?php echo e(asset('assets/js/optional/bootstrap-multiselect.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/js/pages/bootstrap-datetimepicker.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/pages/bootstrap-contextmenu.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/business/treeview.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/js/pages/bootstrap-switch.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/pages/summernote.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/pages/scrollable.js')); ?>"></script>
    ...
    //         $(".kt-menu__item--submenu").not(type_id).removeClass('kt-menu__item--open');
    //         $(type_id).addClass('kt-menu__item--open');
    ...
    //     } else {
    //         load_vms_page('dashboard');
    //         $('#dashboard').parent().addClass('kt-menu__item--active');
    //     }

    //     $(".vms_menu_item").each(function(index) {
    //         $(this).on('click', function(e) {
    //             e.preventDefault();
    //             load_vms_page($(this).data('rel'));
    //             $(".vms_menu_item").not($(this)).parent().removeClass('kt-menu__item--active');
    //             $(".kt-menu__item--submenu").not($(this)).parent().removeClass(
    //                 'kt-menu__item--open');
    ...
    // function load_vms_page(page_name = null) {
    //     $("#load_vms_content").html(
    //         '<center><div style="position: absolute; left: 50%; top: 40%;"><img src=<?php echo e(asset("assets/images/loading.gif")); ?> style="width:130px; height:auto;"></div></center>'
    //     ).load("<?php echo e(url('dashboard/dashboard')); ?>/" + page_name);
    // }
    ...
    $(document).ready(function(e) {
        ...
        $('.kt-menu__item a[href="' + url + '"]').addClass('kt-menu__item--active');
...
</html><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/layouts/enduser/dashboard/master.blade.php ENDPATH**/ ?>