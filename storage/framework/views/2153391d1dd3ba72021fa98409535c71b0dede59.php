...
<div class="kt-grid kt-grid--hor kt-grid--root">
    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
        ...
        <?php echo $__env->make('layouts.admin.sideber', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- end:: Aside -->
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
            ...
            <div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
                    ...
                    <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
                        <ul class="kt-menu__nav ">
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel">
                                <a href="<?php echo e(route('admin.dealer.business')); ?>" target='_blank' class="kt-menu__link">
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                            <span class="kt-header__topbar-icon">
                                <img class="" src="<?php echo e(asset('assets/media/flags/020-flag.svg')); ?>" alt="" />
                            </span>
                        </div>
                            ...
                            <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                <li class="kt-nav__item kt-nav__item--active">
                                    <a href="#" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img src="<?php echo e(asset('assets/media/flags/020-flag.svg')); ?>" alt="" /></span>
                                        <span class="kt-nav__link-text">English</span>
                                    </a>
                                </li>
                                <li class="kt-nav__item">
                                    <a href="#" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img src="<?php echo e(asset('assets/media/flags/bd_flag.jpg')); ?>" alt="" /></span>
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                            <div class="kt-header__topbar-user">
                                ...
                                <img class="" alt="Pic" src="<?php echo e(asset('public/uploads/user/'.Auth::user()->image)); ?>" />
                                <?php endif; ?>
                        ...
                        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                            ...
                            <div class="kt-notification">
                                <a href="<?php echo e(route('profile.index')); ?>" class="kt-notification__item">
                                ...
                                <div class="kt-notification__custom kt-space-between">
                                    <a class="btn btn-label btn-label-brand btn-sm btn-bold" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                ...
                <!-- end:: Header Topbar -->
            </div><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/layouts/admin/navber.blade.php ENDPATH**/ ?>