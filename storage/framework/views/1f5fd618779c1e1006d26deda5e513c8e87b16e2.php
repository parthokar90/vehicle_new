...
<form action="" id="editUsersForm" method="post">
    ...
    <?php echo e(method_field('PUT')); ?>
        ...
        <div class="row form-group">
            <label for="employment_id" class="col-3 col-form-label">Role</label>
...
<script>
    ...
    $('form#editUsersForm').submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(route('department.update', '')); ?>/"+id,
...
</script><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/enduser/department/edit.blade.php ENDPATH**/ ?>