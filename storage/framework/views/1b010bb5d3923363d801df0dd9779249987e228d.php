            ...
            <form id="saveComplainForm">
                <div class="modal-body  text-dark">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="hidden" name="complain_of" value="<?php echo e($vehicle_id); ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select name="complain_group" id="complain_group" class="form-control kt-select2-2">
                                <?php echo e(generate_simple_dropdown('complain_types','name', 'module_id=3 and parent_id=0')); ?>
...
<script>
    ...
    $(function() {
        ...
        var table = $('#complain_table').DataTable({
            ...
            ajax: {
                type: "GET",
                url: "<?php echo e(url('dashboard/vehicle_wise_datatable/complain/'.$vehicle_id)); ?>",
                data: function(d) {
...
</script><?php /**PATH C:\xampp\htdocs\vehicle_new\resources\views/enduser/dashboard/vehicle/complain.blade.php ENDPATH**/ ?>