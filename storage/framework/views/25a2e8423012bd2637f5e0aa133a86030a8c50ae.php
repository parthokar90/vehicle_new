        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="javascript:;" class="kt-subheader__breadcrumbs-link">Vendor Bill</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row all_client">
            <div class="col-sm-12 order-lg-3 order-xl-1">
                ...
                <div class="kt-portlet kt-portlet--height-fluid custom-kt-portlet--height-fluid ">
                    <div class="kt-portlet__head ">
                        <div class="kt-portlet__head-label">
                            <h5 class="kt-portlet__head-title">Vendor bill list
                                <!-- <button type='button'
...
$(document).ready(function() {
    ...
    load_vendor_bill_table();
});

function load_vendor_bill_table() {
    var table = $('#vendor_bill_table').DataTable({
        // destroy: true,
        // processing: true,
        // serverSide: true,
        // ajax: {
    ...
    table.buttons().container().appendTo('#vendor_bill_table_length');
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\angular\resources\views/enduser/dashboard/vendor_bill_view.blade.php ENDPATH**/ ?>