                            ...
                            <div class="row">
                                <div class="col-lg-6 custom-form-group-border">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control" style="height:40px"> <?php echo e($customer->customer_name); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Company Name </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control" style="height:40px"> <?php echo e($customer->name); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Father Name </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->father_name); ?></span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->mother_name); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span
                                                class="form-control"><?php echo e(date('d M yy', strtotime($customer->date_of_birth))); ?></span>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Spouse Name </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->spouse_name); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Spouse Phone </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->spouse_phone); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Occupation </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->occupation); ?></span>
                                        </div>
                                    </div> -->
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">NID No </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->nid_no); ?></span>
                                        </div>
                                    </div>
                                    <!-- <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Passport No </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->passport_no); ?></span>
                                        </div>
                                    </div> -->
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <?php if($customer->division): ?>
                                            <span class="form-control"> <?php echo e($customer->divisions->name); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            ...
                                            <span class="form-control"> <?php echo e($customer->districts->name); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <?php if($customer->thana): ?>
                                            <span class="form-control"> <?php echo e($customer->thanas->name); ?></span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->present_address); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Permanent Address </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->permanent_address); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Billing Address </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->billing_address); ?></span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 custom-form-group-border">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->customer_due_limit); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">SMS Phone </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->phone); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Contact One </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->contact_1); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Contact Two </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->contact_2); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Email</label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->email); ?></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control">
                                                <?php echo e(date('d M yy', strtotime($customer->ac_opening_date))); ?></span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-form-label col-md-4 col-sm-3">Account Note </label>
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->accounts_note); ?></span>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->hosting_company); ?></span>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-9">
                                            <span class="form-control"> <?php echo e($customer->username); ?></span>
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="customer_id"
                                                    value="<?php echo e($customer->customer_id); ?>" disabled>
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2" name="employee">
                                                    ...
                                                    <option value="<?php echo e($user->id); ?>"
                                                        <?php echo e(( $user->id == $customer->employee_id) ? 'selected' : ''); ?>>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="customer_name"
                                                    value="<?php echo e($customer->customer_name); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="mother_name"
                                                    value="<?php echo e($customer->mother_name); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group date">
                                                    <input type="text" name="date_of_birth" class="form-control datepicker" value="<?php echo e($customer->date_of_birth); ?>" />
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                ...
                                                <select class="form-control kt-select2-2" id="division"
                                                    ...
                                                    <option value="<?php echo e($div->id); ?>"
                                                        <?php echo e(( $div->id == $customer->division) ? 'selected' : ''); ?>>
                                                        <?php echo e($div->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2 districtList" id="district"
                                                    ...
                                                    <option value="<?php echo e($dis->id); ?>"
                                                        <?php echo e(( $dis->id == $customer->district) ? 'selected' : ''); ?>>
                                                        <?php echo e($dis->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2 thanaList" id="thana_id"
                                                    name="thana">
                                                    <?php $__currentLoopData = $thanas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($tha->id); ?>"
                                                        <?php echo e(( $tha->id == $customer->thana) ? 'selected' : ''); ?>>
                                                        <?php echo e($tha->name); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="nid_no"
                                                    value="<?php echo e($customer->nid_no); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2" name="gender">
                                                    ...
                                                    <option value="1" <?php echo e(($customer->gender==1) ? 'selected' : ''); ?>>Male
                                                    </option>
                                                    <option value="2" <?php echo e(($customer->gender==2) ? 'selected' : ''); ?>>Female
                                                    </option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <textarea class="form-control" name="present_address"
                                                    rows="3"><?php echo e($customer->present_address); ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <textarea class="form-control" name="permanent_address"
                                                    rows="3"><?php echo e($customer->permanent_address); ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <textarea class="form-control" name="billing_address"
                                                    rows="3"><?php echo e($customer->billing_address); ?></textarea>
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="contact_one"
                                                        value="<?php echo e($customer->contact_1); ?>">
                                                    <div class="input-group-append"><span class="input-group-text"><i
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="contact_two"
                                                        value="<?php echo e($customer->contact_2); ?>">
                                                    <div class="input-group-append"><span class="input-group-text"><i
                                                                class="fas fa-phone"></i></span></div>
                                                </div>
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="latitude"
                                                        value="<?php echo e($customer->latitude); ?>">
                                                    <div class="input-group-append"><span class="input-group-text"><i
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" class="form-control" name="longitude"
                                                        value="<?php echo e($customer->longitude); ?>">
                                                    <div class="input-group-append"><span class="input-group-text"><i
                                                                class="fab fa-google"></i></span></div>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <textarea class="form-control" name="short_note"
                                                    rows="3"><?php echo e($customer->short_note); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-12">
                                            <input type="text" class="form-control" name="company_website"
                                                value="<?php echo e($customer->website); ?>">
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="skype_id"
                                                    value="<?php echo e($customer->skype_id); ?>">
                                                <div class="input-group-append"><span class="input-group-text"><i
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="facebook_url"
                                                    value="<?php echo e($customer->facebook); ?>">
                                                <div class="input-group-append"><span class="input-group-text"><i
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="twitter_url"
                                                    value="<?php echo e($customer->twitter); ?>">
                                                <div class="input-group-append"><span class="input-group-text"><i
                                        ...
                                        <div class="col-lg-7 col-md-8 col-sm-12">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="linkedin_url"
                                                    value="<?php echo e($customer->linkedin); ?>">
                                                <div class="input-group-append"><span class="input-group-text"><i
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="platform_username"
                                                    value="<?php echo e($customer->hosting_company); ?>">
                                        ...
                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="port"
                                                    value="<?php echo e($customer->port); ?>">
                                    ...
                                    <div class="tab-pane" id="tab-eg1-4" role="tabpanel">
                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2" name="package_type">
                                                    <option value="1" <?php echo e(($customer->package_type==1) ? 'selected' : ''); ?>>
                                                        Prepaid</option>
                                                    <option value="2" <?php echo e(($customer->package_type==2) ? 'selected' : ''); ?>>
                                                        Postpaid</option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <input type="text" class="form-control" name="customer_due_limit"
                                                    value="<?php echo e($customer->customer_due_limit); ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <div class="input-group date">
                                                    <input type="text" name="ac_opening_date" class="form-control datepicker" value="<?php echo e($customer->ac_opening_date); ?>" autocomplete="off"/>
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">
                                                            <i class="la la-calendar"></i>
                                                        </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <textarea class="form-control" name="accounts_note"
                                                    rows="3"><?php echo e($customer->accounts_note); ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-md-8 col-sm-12">
                                                <select class="form-control kt-select2-2 kt-select2-2"
                                                    name="global_status">
                                                    <option value="0" <?php echo e(($customer->global_status==0) ? 'selected' : ''); ?>>
                                                        Inactive</option>
                                                    <option value="1" <?php echo e(($customer->global_status==1) ? 'selected' : ''); ?>>
                                                        Active</option>
                                                    <option value="2" <?php echo e(($customer->global_status==2) ? 'selected' : ''); ?>>
                                                        Overdue</option>
                                                    <option value="3" <?php echo e(($customer->global_status==3) ? 'selected' : ''); ?>>
                                                        On
                                                        Hold</option>
                                                    <option value="4" <?php echo e(($customer->global_status==4) ? 'selected' : ''); ?>>
                                                        Stop
                                                    </option>
                                                </select>
...
</script><?php /**PATH C:\xampp\htdocs\vehicle_new\resources\views/enduser/dashboard/customer/customer_info.blade.php ENDPATH**/ ?>