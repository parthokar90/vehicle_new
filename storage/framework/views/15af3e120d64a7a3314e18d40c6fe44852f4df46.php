...
$(function() {
    ...
    var table = $('#vehicle_group_table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(url('dashboard/getVehicleGroupData')); ?>",
            data: function() {
...
$('#saveVehicleGroupForm').submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo e(url('dashboard/saveVehicleGroup')); ?>/" + id,
...
$('#saveAssingGroupForm').submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo e(url('dashboard/vehicle-assign-group')); ?>/" + id,
...
function edit_data(id) {
    $.ajax({
        url: "<?php echo e(url('dashboard/vehicle-group-detail')); ?>/" + id,
        type: "GET",
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/enduser/dashboard/vehicle_group.blade.php ENDPATH**/ ?>