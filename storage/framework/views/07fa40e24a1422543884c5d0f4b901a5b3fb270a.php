        ...
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="" class="kt-subheader__breadcrumbs-link">Permission List</a>
                </div>
            </div>
...
<script>
    ...
    $(function () {      
        ...
        var table= $('#user_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(route('permit.index')); ?>",
                data: function (d) {
    ...
    $(function () {
        ...
        $('.add_user').click(function (e) {
            ...
            $.ajax({
                url: "<?php echo e(route('permit.create')); ?>",
                type: "GET",
    ...
    function view_data(id){
        $.ajax({
            url: "<?php echo e(url('dashboard/user')); ?>/"+id,
            type: "GET",
    ...
    function edit_data(id){
        $.ajax({
            url: "<?php echo e(route('permit.index')); ?>/"+id+"/edit",
            type: "GET",
    ...
    function reset_password(id){
        $("#load_modal_content").load("<?php echo e(url('user_reset_password')); ?>/"+id);
    }
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/enduser/permission/index.blade.php ENDPATH**/ ?>