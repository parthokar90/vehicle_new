                            ...
                            <div class="row">
                                <div class="col-md-10 col-sm-9">
                                    <select name="maintenance_type" id="maintenance_type_list"
                                        ...
                                        <?php $__currentLoopData = $main_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$(function() {
    ...
    var table = $('#maintenance_table').DataTable({
        ...
        responsive: true,
        ajax: {
            url: "<?php echo e(url('dashboard/vehicle_wise_datatable/maintenance/'.$vehicle_id)); ?>",
            data: function(d) {
...
function edit_data(id) {
    ...
    $.ajax({
        type: "json",
        url: "<?php echo e(url('dashboard/editMaintenanceData')); ?>/" + id,
        type: "GET",
...
$('#saveMaintenanceForm').submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo e(url('dashboard/saveMaintenanceData')); ?>/" + id,
...
$('#submitMainType').click(function(event) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo e(url('dashboard/saveMainTypeData')); ?>/" + id,
...
function fatchMainTypeList(lastInsertId = null) {
    $.ajax({
        type: "json",
        url: "<?php echo e(url('dashboard/commonFunction/maintenance_types/name')); ?>",
        type: "GET",
        success: function(data) {
...
</script><?php /**PATH C:\xampp\htdocs\vehicle_new\resources\views/enduser/dashboard/vehicle/maintenance.blade.php ENDPATH**/ ?>