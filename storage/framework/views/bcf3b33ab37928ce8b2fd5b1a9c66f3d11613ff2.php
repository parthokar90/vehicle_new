            ...
            <form id="saveDocumentForm">
                <div class="modal-body  text-dark">
                    ...
                    <div class="form-group row">
                        ...
                        <input type="hidden" name="vehicle_no" id="vehicle_no" value="<?php echo e($vehicle_id); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-sm-9">
                                    <select name="document_type" id="document_type_list" class="form-control kt-select2-2 ">
                                        ...
                                        <?php $__currentLoopData = $doc_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="kt-avatar kt-avatar--outline kt-avatar--circle" id="kt_apps_user_add_avatar">
                                <div>
                                    <img class="kt-avatar__holder" id="img-crop"
                                        src="<?php echo e(asset('assets/media/images/doc.jpg')); ?>" alt="" style="border-radius:0">
                                </div>
...
$(function() {
    ...
    var table = $('#document_table').DataTable({
        ...
        responsive: true,
        ajax: {
            url: "<?php echo e(url('dashboard/vehicle_wise_datatable/document/'.$vehicle_id)); ?>",
            data: function(d) {
...
$('#saveDocumentForm').submit(function(event) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo e(url('dashboard/saveDocumentData')); ?>/" + id,
...
$('#submitDocTypeLog').click(function(event) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo e(url('dashboard/saveDocTypeData')); ?>/" + id,
...
function edit_data(id) {
    ...
    $.ajax({
        type: "json",
        url: "<?php echo e(url('dashboard/editDocumentData')); ?>/" + id,
        type: "GET",
...
function fatchDocTypeList(lastInsertId = null) {
    $.ajax({
        type: "json",
        url: "<?php echo e(url('dashboard/commonFunction/doc_types/name')); ?>",
        type: "GET",
        success: function(data) {
...
</script><?php /**PATH C:\xampp\htdocs\vehicle_new\resources\views/enduser/dashboard/vehicle/document.blade.php ENDPATH**/ ?>