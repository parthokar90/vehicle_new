    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid driver_data_list">
        ...
        <div class="kt-portlet kt-portlet--height-fluid custom-kt-portlet--height-fluid" id="at_a_glance">
            ...
            <div class="kt-portlet__body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="card custom-card" style="background-image: url('<?php echo e(asset("assets/media/misc/bg-1.jpg")); ?>')">
                    ...
                    <div class="col-md-4">
                        <div class="card custom-card" style="background-image: url('<?php echo e(asset("assets/media/bg/b.png")); ?>')">
                            <div class="card-body custom-card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card custom-card" style="background-image: url('<?php echo e(asset("assets/media/bg/v.png")); ?>')">
                            <div class="card-body custom-card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card custom-card" style="background-image: url('<?php echo e(asset("assets/media/bg/br.png")); ?>')">
                            <div class="card-body custom-card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card custom-card" style="background-image: url('<?php echo e(asset("assets/media/bg/r.png")); ?>')">
                            <div class="card-body custom-card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card custom-card" style="background-image: url('<?php echo e(asset("assets/media/bg/bg-7.jpg")); ?>')">
                            <div class="card-body custom-card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <div class="input-group">
                                ...
                                <input type="text" name="refill_date" id="refill_date" class="form-control datepicker" placeholder="DD/MM/YYYY" autocomplete="off" value="<?php echo e(date('d M Y')); ?>" />
...
<script>
    ...
    function fuel_datatable() {
        ...
        var table = $('#fuel_log_table').DataTable({
            ...
            ajax: {
                type: "POST",
                url: "<?php echo e(url('dashboard/fuelLogData')); ?>",
                data: {
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    title: 'custom Title',
                    // messageTop: "<?php echo e(report_template('print', 'header')); ?>",
    ...
    function at_a_glance() {
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(url('dashboard/fuel_at_a_glance')); ?>",
            data: {
    ...
    $('#saveFuelLogForm').submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(url('dashboard/saveFuelCostData')); ?>/" + id,
    ...
    function get_vehicle_list() {
        $.ajax({
            type: "GET",
            dataType: "html",
            url: "<?php echo e(url('dashboard/get_vehicle_list')); ?>",
            success: function(result) {
    ...
    function edit_data(id) {
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "<?php echo e(url('dashboard/fuel-log-detail')); ?>/" + id,
            success: function(result) {
                console.log(result);
    ...
    $(document).on('change', '#vehicle_no', function() {
        if (this.value > 0) {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: "<?php echo e(url('dashboard/getVehicleInfo')); ?>/" + this.value + "/" + staff,
                success: function(result) {
                    console.log(result);
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/enduser/dashboard/fuel_log.blade.php ENDPATH**/ ?>