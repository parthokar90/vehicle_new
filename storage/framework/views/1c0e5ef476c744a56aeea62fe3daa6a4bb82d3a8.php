...
<script>
    ...
    $(function () {      
        ...
        var table= $('#user_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(url('dashboard/user')); ?>",
                data: function (d) {
    ...
    $(function () {
        ...
        $('.add_user').click(function (e) {
            ...
            $.ajax({
                url: "<?php echo e(url('dashboard/user/create')); ?>",
                type: "GET",
    ...
    function edit_data(id){
        $.ajax({
            url: "<?php echo e(url('dashboard/user')); ?>/"+id+"/edit",
            type: "GET",
...
<?php echo $__env->make('layouts.enduser.dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/enduser/dashboard/users/index.blade.php ENDPATH**/ ?>