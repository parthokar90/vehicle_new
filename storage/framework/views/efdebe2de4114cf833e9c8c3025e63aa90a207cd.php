...
<head>
    ...
    <link href="<?php echo e(asset('assets/css/pages/login-4.css')); ?>" rel="stylesheet" />
...
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
    ...
    <div class="kt-grid kt-grid--ver kt-grid--root">
        <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v4 kt-login--signin" id="kt_login">
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor custom-login-display" style="background-image: url('<?php echo e(asset("uploads/system_config/".$system_config->template_bg)); ?>')">
                <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                    <div class="kt-login__container">
                        <div class="kt-login__logo">
                            <a href="#">
                                <img class="login_template_logo" src="<?php echo e(asset('uploads/system_config/'.$system_config->template_logo)); ?>">
                            </a>
                        </div>
                        <div class="kt-login__signin">
                            <div class="kt-login__head">
                                <h3 class="kt-login__title"><?php echo e($system_config->template_heading); ?></h3>
                ...
                <div class="login_footer_section">
                    <ul class="nav justify-content-end">
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:;"><img class="footer_logo" src="<?php echo e(asset('assets/media/logos/LiveSupport.png')); ?>" alt=""></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:;"><img class="footer_logo" src="<?php echo e(asset('assets/media/logos/Apple.png')); ?>" alt=""></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:;"><img class="footer_logo" src="<?php echo e(asset('assets/media/logos/PlayStore.png')); ?>" alt=""></a>
                        </li>
    ...
    <script src="<?php echo e(asset('assets/js/pages/login-general.js')); ?>"></script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response == 0) {
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(route('systemadmin.dashboard')); ?>"
                        }, 500);
                    } else if (response == 4) {
                        swal.fire({
                            type: 'success',
                        ...
                        setTimeout(function() {
                            window.location.href = "<?php echo e(url('dashboard/d/dashboard')); ?>"
                        }, 500);
                    }
                },
...
</html><?php /**PATH C:\xampp\htdocs\gopronew_prototype\resources\views/auth/login.blade.php ENDPATH**/ ?>