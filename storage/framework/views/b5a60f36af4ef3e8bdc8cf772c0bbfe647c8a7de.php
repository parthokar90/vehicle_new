...
<head>
    ...
    <link href="<?php echo e(asset('assets/css/monitor/v1/monitor_v1_custom.css')); ?>" rel="stylesheet" />
    <!--end::Layout Skins -->
    ...
    <script src="<?php echo e(asset('assets/js/angular-filter.js')); ?>"></script>
    ...
    #gauge {
        ...
        position: relative;
        height: 190px;
        background:url("<?php echo e(asset('assets/images/speedometer_back.png')); ?>") no-repeat;
    }
    ...
    #circle {
        width: 79px;
        height: 79px;
        background: url("<?php echo e(asset('assets/images/speedo_circle_1.png')); ?>")no-repeat;
        bottom: 45px;
        left: 68px;
        position: absolute;
    }
    ...
    #circle_2 {
        width: 79px;
        height: 79px;
        background: url("<?php echo e(asset('assets/images/speedo_circle_2.png')); ?>")no-repeat;
        bottom: 39px;
        left: 74px;
        position: absolute;
        z-index: 9999999;
...
<body
    ...
    id="monitor_body" ng-app="monitorApp" ng-controller="monitorCtrl" ng-cloak id="monitor_body">
    ...
    <div class="kt-grid kt-grid--hor kt-grid--root">
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
            ...
            <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop"
                ...
                <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                    <div class="kt-aside__brand-logo">
                        <a href="<?php echo e(route('enduser.dashboard')); ?>">
                            <?php if(Auth::user()->company_dark_logo): ?>
                            <img src="<?php echo e(asset('uploads/user/logos/'.Auth::user()->company_dark_logo)); ?>"
                                alt="Logo" style="height:40px">
                            <?php else: ?>
                            <img alt="Logo" src="<?php echo e(asset('assets/media/logos/crm-logo-black-2.png')); ?>"
                                style="height:40px" />
                            <?php endif; ?>
                        </a>
                    </div>
                            ...
                            <div class="kt-quick-search__form custom-kt-quick-search__form1">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control kt-quick-search__input"
                                        placeholder="Search Account" id="dealer_search">
                        ...
                        <div class="panel-bottom">
                            <div class="custom-tabs">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a data-toggle="tab" href="#objects"
                                            class="active nav-link">Objects</a></li>
                                    <li class="nav-item"><a data-toggle="tab" href="#events" class="nav-link"
                                            ng-click="show_event_list()">Events</a>
                                    </li>
                                    <li class="nav-item"><a data-toggle="tab" href="#places" class="nav-link"
                                            ng-click="show_geofence_list()">Places</a>
                                    </li>
                                    <li class="nav-item"><a data-toggle="tab" href="#history"
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="objects" role="tabpanel">
                                    <div id="device_list_loader" class="col-sm-12 text-center d-none"
                                        style="position: absolute;    left: 0%; align-items: center; justify-content: center; z-index: 999999;    height: calc(100vh - 51px);  width: 100%;  padding-top: 15%; background:rgba(255,255,255,0.8);">
                                    ...
                                    <div class="kt-quick-search kt-quick-search--inline custom-search-section">
                                        <form method="get" class="kt-quick-search__form custom-kt-quick-search__form">
                                            <div class="input-group">
                                                ...
                                                <input type="text" ng-model="search_device"
                                    ...
                                    <div class="group-heading mt-2">
                                        <ul class="nav nav-pills nav-pills-sm nav-pills-label nav-pills-bold"
                                            role="tablist">
                                            <li class="nav-item">
                                                <a class="custom-link-color nav-link active" data-toggle="tab"
                                                    href="#all_device_tab" role="tab">
                                                    All({{all_devices.length}})
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="custom-link-color nav-link" data-toggle="tab"
                                                    href="#online_device_tab" role="tab">
                                                    Online({{online_devices.length}})
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="custom-link-color nav-link" data-toggle="tab"
                                                    href="#offline_device_tab" role="tab">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="all_device_tab">
                                            ...
                                            <div ng-repeat="all_groups in all_device_groups" class="accordion mt-2"
                                                id="all_group_{{all_groups.id}}">
                                                <div class="">
                                                    <div class="group-heading"
                                                        id="heading_all_group_{{all_groups.id}}">
                                                        <h5 class="demo-heading">
                                                            ...
                                                            <a href="#collapse1-all_group_{{all_groups.id}}"
                                                                class="custom-card-title" data-toggle="collapse">
                                                                {{all_groups.group_name}}
                                                            </a>
                                                            <a href="#collapse1-all_group_{{all_groups.id}}"
                                                                id="collaplse-arrow_all_{{all_groups.id}}"
                                                                class="collaplse-arrow custom-link-color"
                                                                data-toggle="collapse">
                                                                <i id="arrow-sign_all_{{all_groups.id}} "
                                                                    class="arrow-sign fas fa-caret-down"></i>
                                                            </a>
                                                        </h5>
                                                    </div>
                                                    <div id="collapse1-all_group_{{all_groups.id}}"
                                                        class="collapse show groupwise_device_list"
                                                        aria-labelledby="heading_all_group_{{all_groups.id}}"
                                                        data-parent="#all_group_{{all_groups.id}}">
                                                        <div class="sidebar_list_group">
                                                            <ul class="list-group">
                                                                <li ng-repeat="all_d in all_devices | filterBy: ['device_name','imei','sim_number']: search_device"
                                                                    ...
                                                                    <span>
                                                                        ...
                                                                        <img src="{{all_d.list_device_icon}}"
                                                                            height="25">
                                                                        <a href="javascript:;"
                                                                            class="custom-link custom-link-text"
                                                                            ng-click="openMarkerByID(all_d.imei)">{{all_d.device_name}}
                                                                            <span
                                                                                class="custom-data-span">{{all_d.ststr}}</span></a>
                                                                    </span>
                                                                    <span>
                                                                        <a href="javascript:;"
                                                                            class="custom-link">{{all_d.speed}} kmh</a>
                                                                        <span class="ml-2" ng-if="(all_d.speed<=0)"> <i
                                                                                class="fas fa-wifi"></i></span>
                                                                        <span class="ml-2" ng-if="(all_d.speed>0)"><img
                                                                                src="{{all_d.wifi_icon}}"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <ul class="kt-nav custom-onclick-option">
                                                                                <li class="kt-nav__item">
                                                                                    <a href="javascript:;"
                                                                                        ng-click="device_details(all_d.id)"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/detail.png')); ?>"
                                                                                            alt="">
                                                                                        <span
                                                                                            class="kt-nav__link-text">Details</span>
                                                                                    </a>
                                                                                </li>
                                                                                <li class="kt-nav__item">
                                                                                    <a href="<?php echo e(url('dashboard/playback')); ?>/{{all_d.imei}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/playback.png')); ?>"
                                                                                            alt="">
                                                                                        <span
                                                                                            class="kt-nav__link-text">Playback</span>
                                                                                    </a>
                                                                                </li>
                                                                                <li class="kt-nav__item">
                                                                                    <a href="<?php echo e(url('dashboard/report?report_type=quick&report_name=trip_report&imei=')); ?>{{all_d.imei}}_{{all_d.device_name}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/report.png')); ?>"
                                                                                            alt="">
                                                                                        <span
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="javascript:;"
                                                                                        ng-click="add_complain(all_d.id, all_d.device_name)"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/report.png')); ?>"
                                                                                            alt="">
                                                                                        <span
                                                                                            class="kt-nav__link-text">Complain</span>
                                                                                    </a>
                                                                                </li>
                                                                                <li class="kt-nav__item">
                                                                                    <a href="javascript:;"
                                                                                        ng-click="device_command(all_d)"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/command.png')); ?>"
                                                                                            alt="">
                                                                                        <span
                                                                                            class="kt-nav__link-text">Command</span>
                                                                                    </a>
                                                                                </li>
                                        ...
                                        <div class="tab-pane" id="online_device_tab">
                                            <div ng-repeat="online_groups in online_device_groups"
                                                class="accordion mt-2" id="online_group_{{online_groups.id}}">
                                                <div class="">
                                                    <div class="group-heading"
                                                        id="heading_online_group_{{online_groups.id}}">
                                                        <h5 class="demo-heading ">
                                                            ...
                                                            <a href="#collapse1-online_group_{{online_groups.id}}"
                                                                class="custom-card-title" data-toggle="collapse">
                                                                {{online_groups.group_name}}
                                                            </a>
                                                            <a href="#collapse1-online_group_{{online_groups.id}}"
                                                                id="collaplse-arrow_online_{{online_groups.id}}"
                                                                class="collaplse-arrow custom-link-color"
                                                                data-toggle="collapse">
                                                                <i id="arrow-sign_online_{{online_groups.id}} "
                                                                    class="arrow-sign fas fa-caret-down"></i>
                                                            </a>
                                                        </h5>
                                                    </div>
                                                    <div id="collapse1-online_group_{{online_groups.id}}"
                                                        class="collapse show groupwise_device_list"
                                                        aria-labelledby="heading_online_group_{{online_groups.id}}"
                                                        data-parent="#online_group_{{online_groups.id}}">
                                                        <div class="sidebar_list_group">
                                                            <ul class="list-group">
                                                                <li ng-repeat="online in online_devices"
                                                                    class="list-group-item custom-list-group-item d-flex justify-content-between align-items-center">
                                                                    <span>
                                                                        <img src="{{online.list_device_icon}}"
                                                                            height="25">
                                                                        <a href="javascript:;"
                                                                            class="custom-link custom-link-text"
                                                                            ng-click="openMarkerByID(online.imei)">{{online.device_name}}
                                                                            <span
                                                                                class="custom-data-span">{{online.ststr}}</span></a>

                                                                    </span>
                                                                    <span>
                                                                        <a href="javascript:;"
                                                                            class="custom-link">{{online.speed}}
                                                                            kmh</a>
                                                                        <span class="ml-2"><img
                                                                                src="{{online.wifi_icon}}"
                                                                                style="width: 18px; height: 18px; "></span>
                                                                        <a href="javascript:;" class="ml-2"
                                                                            data-toggle="dropdown">
                                                                            <i class="fas fa-ellipsis-v"></i>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <ul class="kt-nav custom-onclick-option">
                                                                                <li class="kt-nav__item">
                                                                                    <a href="javascript:;"
                                                                                        ng-click="device_details(online.id)"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/detail.png')); ?>"
                                                                                            alt="">
                                                                                        <span
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="<?php echo e(url('dashboard/playback')); ?>/{{online.imei}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/playback.png')); ?>"
                                                                                            alt="">
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="<?php echo e(url('dashboard/report?report_type=quick&report_name=trip_report&imei=')); ?>{{online.imei}}_{{online.device_name}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/report.png')); ?>"
                                                                                            alt="">
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="javascript:;"
                                                                                        ng-click="add_complain(online.id, online.device_name)"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/report.png')); ?>"
                                                                                            alt="">
                                                                                        <span
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="javascript:;"
                                                                                        ng-click="device_command(online)"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/command.png')); ?>"
                                                                                            alt="">
                                                                                        <span
                                        ...
                                        <div class="tab-pane" id="offline_device_tab">
                                            <div ng-repeat="offline_groups in offline_device_groups"
                                                class="accordion mt-2" id="offline_group_{{offline_groups.id}}">
                                                <div class="">
                                                    <div class="group-heading"
                                                        id="heading_offline_group_{{offline_groups.id}}">
                                                        <h5 class="demo-heading ">
                                                            ...
                                                            <a href="#collapse1-offline_group_{{offline_groups.id}}"
                                                                class="custom-card-title" data-toggle="collapse">
                                                                {{offline_groups.group_name}}
                                                            </a>
                                                            <a href="#collapse1-offline_group_{{offline_groups.id}}"
                                                                id="collaplse-arrow_offline__{{offline_groups.id}}"
                                                                class="collaplse-arrow custom-link-color"
                                                                data-toggle="collapse">
                                                                <i id="arrow-sign_offline__{{offline_groups.id}} "
                                                                    class="arrow-sign fas fa-caret-down"></i>
                                                            </a>
                                                        </h5>
                                                    </div>
                                                    <div id="collapse1-offline_group_{{offline_groups.id}}"
                                                        class="collapse show groupwise_device_list"
                                                        aria-labelledby="heading_offline_group_{{offline_groups.id}}"
                                                        data-parent="#offline_group_{{offline_groups.id}}">
                                                        <div class="sidebar_list_group">
                                                            <ul class="list-group">
                                                                <li ng-repeat="offline in offline_devices"
                                                                    class="list-group-item custom-list-group-item d-flex justify-content-between align-items-center">
                                                                    <span>
                                                                        <img src="{{offline.list_device_icon}}"
                                                                            height="25">
                                                                        <a href="javascript:;"
                                                                            class="custom-link custom-link-text"
                                                                            ng-click="openMarkerByID(offline.imei)">{{offline.device_name}}
                                                                            <span
                                                                                class="custom-data-span">{{online.ststr}}</span></a>
                                                                    </span>
                                                                    <span>
                                                                        <a href="javascript:;"
                                                                            class="custom-link">{{offline.speed}}
                                                                            kmh</a>
                                                                        <span class="ml-2"><i
                                                                                class="fas fa-wifi"></i></span>
                                                                        <a href="javascript:;" class="ml-2"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <ul class="kt-nav custom-onclick-option">
                                                                                <li class="kt-nav__item">
                                                                                    <a href="javascript:;"
                                                                                        ng-click="device_details(offline.id)"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/detail.png')); ?>"
                                                                                            alt="">
                                                                                        <span
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="<?php echo e(url('dashboard/playback')); ?>/{{offline.imei}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/playback.png')); ?>"
                                                                                            alt="">
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="<?php echo e(url('dashboard/report?report_type=quick&report_name=trip_report&imei=')); ?>{{offline.imei}}_{{offline.device_name}}"
                                                                                        target="_blank"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/report.png')); ?>"
                                                                                            alt="">
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="javascript:;"
                                                                                        ng-click="add_complain(offline.id, offline.device_name)"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/report.png')); ?>"
                                                                                            alt="">
                                                                                        <span
                                                                                ...
                                                                                <li class="kt-nav__item">
                                                                                    <a href="javascript:;"
                                                                                        ng-click="device_command(offline)"
                                                                                        class="kt-nav__link">
                                                                                        <img src="<?php echo e(asset('assets/media/icons/command.png')); ?>"
                                                                                            alt="">
                                                                                        <span
                                ...
                                <div class="tab-pane" id="events" role="tabpanel">
                                    <div class="kt-quick-search kt-quick-search--inline custom-search-section">
                                        <form method="get" class="kt-quick-search__form custom-kt-quick-search__form">
                                            <div class="input-group">
                                                ...
                                                <input type="text" ng-model="search_events"
                                                    class="form-control kt-quick-search__input"
                                    ...
                                    <div class="group-heading mt-2">
                                        <ul class="list-group">
                                            <li
                                                class="list-group-item filter-list-group-item  d-flex justify-content-between  align-items-center">
                                                <a href="javascript:;" class="collaplse-arrow custom-link-color">Time <i
                                                        class=" arrow-sign fas fa-caret-down ml-2"></i></a>
                                        ...
                                        <table class="table table-hover table-striped">
                                            <tr ng-repeat=" e in my_event_list | filterBy: ['name','event_desc']: search_events"
                                                style="font-size: 11px;" ng-click="show_in_map(e)">
                                                <td>{{e.dt_tracker}}</td>
                                                <td>{{e.name}}</td>
                                                <td>{{e.event_desc}}</td>
                                            </tr>
                                ...
                                <div class="tab-pane" id="places" role="tabpanel">
                                    <div class="custom-tabs">
                                        <ul class="nav nav-tabs custom-nav-tabs">
                                            <li class="nav-item"><a data-toggle="tab" href="#market"
                                                    class="active nav-link">Markets (0)</a></li>
                                            <li class="nav-item"><a data-toggle="tab" href="#route"
                                                    class="nav-link">Routes (0)</a></li>
                                            <li class="nav-item"><a data-toggle="tab" href="#zone"
                                                    class="nav-link">Zones (0)</a></li>
                                        </ul>
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="market" role="tabpanel">
                                                <div
                                                    class="kt-quick-search kt-quick-search--inline custom-search-section">
                                                    <form method="get"
                                                        class="kt-quick-search__form custom-kt-quick-search__form2">
                                                        <div class="input-group">
                                                    ...
                                                    <table class="table table-hover table-striped">
                                                        <tr ng-repeat=" g in my_geofence_list | filterBy: ['name']: search_geofence"
                                                            style="font-size: 11px;" ng-click="go_to_geofence()">
                                                            <td>{{$index++}}</td>
                                                            <td>{{g.name}}</td>
                                                        </tr>
                                                    </table>
                                                    <div class="custom-buttons ml-1">
                                                        <a href="javascript:;" class="custom-buttons-list"
                                                            title="Reload">
                                                ...
                                                <div class="group-heading mt-2" id="headingOne">
                                                    <h5 class="demo-heading ">
                                                        ...
                                                        <a href="javascript:;" id="collaplse-arrow"
                                                            class="collaplse-arrow custom-link-color">
                                                            <i id="arrow-sign "
                                                                class=" arrow-sign fas fa-caret-down"></i>
                                                        </a>
            ...
            <!-- end:: Aside -->
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper custom-kt-wrapper"
                id="kt_wrapper">

                <?php echo $__env->make('layouts.enduser.top-menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!-- end:: Header -->
                ...
                <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                    ...
                    <!-- begin:: Content -->
                    <div
                        class="kt-container custom-kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
                        ...
                        <div class="row">
                            <div class="kt-portlet mirgin-buttom-none custom-container">
                                <div class="kt-portlet__body custom-portlet-body">
                                    <div class="kt-section--first">
                                        <div class="kt-section__body text-dark">
                                            <div class="kt-widget15">
                                                <div id="show_map_loader" class="col-sm-12 text-center d-none"
                                                    style="position: absolute;    left: 0%; align-items: center; justify-content: center; z-index: 999999;    height: calc(100vh - 51px);  width: 100%;  padding-top: 15%; background:rgba(255,255,255,0.8);">
                                                    <img src="<?php echo e(asset('assets/images/loading.gif')); ?>"
                                                        style="width:130px; height:auto;">
                                                </div>
                ...
                <div class="kt-portlet__body toggleSection ">

                    <div id="show_small_loader" class="col-sm-12 text-center d-none"
                        style="position: absolute; left: 0%; display: flex; align-items: center; justify-content: center; z-index: 99999;">
                        <img src="<?php echo e(asset('assets/images/loading.gif')); ?>" style="width:115px; height:auto;">
                    </div>
                    <span class="sectionHide" title="Minimize"> <i class="fas fa-times"></i></span>
                    <div class="kt-section--first">
                        <div class="kt-section__body text-dark">
                            <ul class="nav nav-tabs custom-nav-tabs">
                                <li class="nav-item"><a data-toggle="tab" id="data_info" href="#data"
                                        class="active nav-link">Data</a></li>
                                <!-- <li class="nav-item"><a data-toggle="tab" href="#graph" class="nav-link">Graph</a></li> -->
                                <li class="nav-item"><a data-toggle="tab" id="complain_function"
                                        ng-click="complain_data(selected_device.id)" href="#complain"
                                        class="nav-link">Complain</a>
                                </li>
                                <li class="nav-item"><a data-toggle="tab" id="vms_rel_function"
                                        ng-click="vms_rel_data(selected_device.id)" href="#vms_info"
                                        class="nav-link">VMS Info</a></li>
                                <li class="nav-item"><a data-toggle="tab" id="driver_function"
                                        ng-click="driver_rel_data(selected_device.id, selected_device.imei, selected_device.device_name)"
                                        href="#driver_info" class="nav-link">Driver Info</a></li>
                            </ul>
                            <div class="tab-content">
                                    ...
                                    <div class="dataListSection">
                                        <div class="dataListItem">
                                            ...
                                            <span class="dataItemValue"> {{selected_device.imei}} -
                                                {{selected_device.model_name}} - <span class="badge"
                                                    style="background-color: {{selected_device.unit_status_color}} ; color:white;">
                                        ...
                                        <div class="dataListItem">
                                            <span class="dataItemIcon"><i
                                                    class="fab fa-acquisitions-incorporated"></i></span>
                                        ...
                                        <div class="dataListItem">
                                            ...
                                            <span class="dataItemName">{{selected_device.device_name}} <span
                                                    class="badge"
                                                    style="background-color:{{selected_device.unit_status_color}}; color:white;">{{selected_device.unit_status_name}}</span></span>
                                        ...
                                        <div class="dataListItem">
                                            ...
                                            <span class="dataItemValue"><a
                                                    href="http://maps.google.com/maps?q={{selected_device.lat}},{{selected_device.lng}}&amp;t=m"
                                                    target="_blank">{{selected_device.lat}}°,
                                                    {{selected_device.lng}}°</a>
                                            </span>
                                        </div>
                                        <div class="dataListItem">
                                            <span class="dataItemIcon"><i class="fas fa-toggle-on"></i></span>
                                            <span class="dataItemName">Address </span>
                                            <span class="dataItemValue" id="myLocation"><button type="button"
                                                    class="btn load_geo_address" data-lat="{{selected_device.lat}}"
                                                    data-lng="{{selected_device.lng}}" style="padding:0">Show
                                                    Address</button>
                                            </span>
                                        </div>
                                        ...
                                        <div class="dataListItem" ng-repeat="s in selected_device.sensor_list"
                                            ng-if="s.is_data_list==1">
                                            <span class="dataItemIcon"><i
                                                    class="fas fa-battery-three-quarters"></i></span>
                                    ...
                                    <div class="ComplainDataSection">
                                        <div class="ComplainDataPart">
                                            <div class="d-flex justify-content-between align-items-center mx-3">
                                                <button type="button" class="custom_button_class"
                                                    id="add_complain_button"
                                                    ng-click="add_complain(selected_device.id, selected_device.device_name)"><i
                                                        class="fas fa-bug mr-2"></i>Add</button>
                                    ...
                                    <div class="VmsDataSection">
                                        <div class="VmsDataPart">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <button type="button" class="custom_button_class" id="add_fuel_button"
                                                    ng-click="add_fuel(selected_device.id, selected_device.device_name)"><i
                                                        class="fas fa-gas-pump mr-2"></i>Add</button>
                                        ...
                                        <div class="VmsDataPart">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <button type="button" class="custom_button_class"
                                                    ...
                                                    ng-click="add_expense(selected_device.id, selected_device.device_name)"><i
                                                        class="fas fa-donate mr-2"></i>Add</button>
                                ...
                                <div class="tab-pane" id="driver_info" role="tabpanel">
                                    ...
                                    <div class="DriverDataSection ">
                                        <span class="d-none text-danger ml-4" id="driver_not_found"
                                            style="min-height:145px"> Driver data
                                        ...
                                        <div class="DriverDataPart d-none">
                                            <div class="driver_photo_section">
                                                <img class="custom-image" id="driver_img"
                                                    src="<?php echo e(asset('assets/media/users/100_3.jpg')); ?>" alt="Image">
                                                <a href="javascript:;" ng-click="go_driver_info()"
                                                    class="driver-view btn btn-success btn-sm"> View details</a>
                                            </div>
                                                            ...
                                                            <div class="kt-widget14__content">
                                                                ...
                                                                <div class="kt-widget14__legends">
                                                                    <div class="kt-widget14__legend">
                                                                        <span
                                                                            class="kt-widget14__bullet kt-bg-danger"></span>
                                                                        <span class="kt-widget14__stats">37% Harsh
                                                                            Break</span>
                                                                    </div>
                                                                    <div class="kt-widget14__legend">
                                                                        <span
                                                                            class="kt-widget14__bullet kt-bg-warning"></span>
                                                                        <span class="kt-widget14__stats">47% Business
                                                                            Events</span>
                                                                    </div>
                                                                    <div class="kt-widget14__legend">
                                                                        <span
                                                                            class="kt-widget14__bullet kt-bg-brand"></span>
                        ...
                        <div class="kt-section kt-section--first">
                            <div class="kt-section__body text-dark">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item"><a data-toggle="tab" href="#edit_device_3"
                                            id="singleDeviceInfo" class="nav-link active">Device Info</a></li>
                                    ...
                                    <li class="nav-item"><a data-toggle="tab" href="#edit_device_5"
                                            ng-click="event_rel_data(selected_device.imei)" class="nav-link">Event</a>
                                    </li>
                                    <li class="nav-item"><a data-toggle="tab" href="#edit_device_6"
                                            class="nav-link">Overview status</a></li>
                                    <li class="nav-item"><a data-toggle="tab" href="#edit_device_7"
                                            class="nav-link">Parameter</a></li>
                                    <li class="nav-item"><a data-toggle="tab" href="#edit_device_8" class="nav-link">Tu
                                            status log</a></li>
                                </ul>
                                <div class="tab-content">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-9 mb-4">
                                                    <input type="hidden" class="form-control" name="edit_device_id"
                                                        id="edit_device_id">
                                                    <input type="text" class="form-control" name="edit_device_name"
                                                        id="edit_device_name" value="">
                                                </div>
                                                <label class="col-lg-2 col-form-label">TU ID</label>
                                                <div class="col-lg-4 col-md-9 mb-4">
                                                    <input type="text" class="form-control" name="edit_unit_id"
                                                        id="edit_unit_id">
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-9 mb-4">
                                                    <input type="text" class="form-control" name="edit_imei"
                                                        id="edit_imei" disabled>
                                                </div>
                                                <label class="col-lg-2 col-form-label">SIM No</label>
                                                <div class="col-lg-4 col-md-9 mb-4">
                                                    <input type="number" class="form-control" name="edit_sim_number"
                                                        id="edit_sim_number">
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-9 mb-4">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" name="edit_opening_date"
                                                ...
                                                <div class="col-lg-4 col-md-9 mb-4">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control"
                                                            name="platform_expire_date" placeholder="MM/DD/YYYY" />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="la la-calendar"></i>
                                                            </span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-9 mb-4">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control"
                                                            id="edit_fuel_consumption_value"
                                                ...
                                                <div class="col-lg-4 col-md-9 mb-4">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" name="fuel_tank_volume"
                                            ...
                                            <div class="row">
                                                <label class="col-lg-2 col-form-label">Average Fuel Price</label>
                                                <div class="col-lg-4 col-md-9 mb-4">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control" id="edit_ave_fuel_price"
                                                            name="edit_ave_fuel_price"
                                                ...
                                                <div class="col-lg-4 col-md-9 mb-4">
                                                    <input type="text" class="form-control" name="user_due"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-md-9 mb-4">
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control"
                                                            name="edit_speeding_value" id="edit_speeding_value"
                                    ...
                                    <div class="tab-pane" id="edit_device_4" role="tabpanel">
                                        <div class="form-group row" ng-repeat="s in selected_device.sensor_list">
                                            <label
                                                class=" col-form-label col-lg-3 col-sm-12">{{s.sensor_type_name}}</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="tab-pane" id="edit_device_5" role="tabpanel">
                                        <table class="table table-hover table-striped table-bordered mt-4"
                                            ...
                                            <tbody id="load_device_event_data">
                                    ...
                                    <div class="tab-pane" id="edit_device_7" role="tabpanel">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9" id="parameters">
                                                <textarea style="border:none" name="" id="" cols="90" rows="3"
                                                    disabled="disabled">{{selected_device.params}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                ...
                <form id="saveFuelLogForm">
                    <div class="modal-body  text-dark">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input type="text" name="refill_date" class="form-control datepicker"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input type="number" class="form-control calculatePrice" id="refill_unit"
                                        name="refill_unit">
                                    <div class="input-group-append">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input type="number" class="form-control calculatePrice" id="unit_price"
                                        name="unit_price">
                                    <div class="input-group-append">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input type="number" class="form-control totalPrice" id="total_price"
                                        name="total_price">
                                    <div class="input-group-append">
                                        <div class="input-group-text">BDT</div>
                                    </div>
            ...
            <div class="modal-content">
                ...
                <form id="saveExpenseLogForm">
                    <div class="modal-body  text-dark">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <input type="text" id="expense_vehicle_no" name="expense_vehicle_no"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input type="text" class="form-control calculatePrice" id="cost_value"
                                        name="cost_value">
                                    <div class="input-group-append">
                                        <div class="input-group-text">BDT</div>
                                    </div>
                    ...
                    <div class="form-button">
                        <button type="button" id="cancle" class="btn btn-danger btn-sm"
                            data-dismiss="modal">Cancel</button>
                        <button type="submit" id="submitExpenseLog"
                            class="btn btn-success btn-sm float-right">Save</button>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select name="problem_type" id="problem_type" class="form-control kt-select2-2">
                                    ...
                                    <?php $__currentLoopData = $complain_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($ct->id); ?>"><?php echo e($ct->t_name); ?></option>
                                                    ...
                                                    <div class="tab-pane fade show active" id="list-home"
                                                        ...
                                                        <form id="saveCommandForm">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-8">
                                                                    <input type="text" class="form-control"
                                                                        id="selected_device_name" disabled="disabled">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-8">
                                                                    <input type="text" class="form-control"
                                                                        id="selected_command_name" disabled="disabled"
                                                                        style="color: #ccc;">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-8">
                                                                    <button type="submit" id="sendCommand"
                                                                        class="btn btn-custom btn-sm"> Send</button>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
    ...
    <div class="modal fade" id="responseModal">
        <div class="modal-dialog modal-dialog-centered" style="z-index:999999">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span class="text-success" id="command_response"></span>
                </div>
            </div>
        </div>
    </div>
    ...
    app.controller('monitorCtrl', function($scope, $http, $window, $interval, $timeout) {
        angular.element(document).ready(function() {
            ...
            $scope.selected_user_details.id = <?php echo $session_data['id'] ?>;
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: "<?php echo e(URL::to('/dashboard/showTree')); ?>/" + <?php echo $customer_id;?>,
                success: function(response) {

                    var first_node = {
                        'id': "<?php echo $session_data['id'] ?>",
                        'text': '<?php echo $parent_string; ?>',
                        'icon': 'fa fa-users',
                        'state': {
                            opened: false
                        },
                        'only_name': "<?php echo $session_data['name'] ?>",
                        'item_details': <?php echo json_encode($session_data);?>,
                        'children': response
                    };
            ...
            user_information(<?php echo $customer_id; ?>);
            var main_search_options = {
                data: <?php echo $searchTree ?>,
        ...
        $scope.all_devices = [];
        var icon_url = "<?php echo e(asset('assets/images')); ?>/";
        var playback_url = "<?php echo e(url('dashboard/playback')); ?>/";
        var report_url = "<?php echo e(url('dashboard/report?report_type=quick&report_name=trip_report&imei=')); ?>";
        var geofence_url = "<?php echo e(url('dashboard/geofence')); ?>/";
        var playback_icon = "<?php echo e(asset('assets/media/icons/playback.png')); ?>/";
        var track_icon = "<?php echo e(asset('assets/media/icons/track.png')); ?>/";
        var command_icon = "<?php echo e(asset('assets/media/icons/command.png')); ?>/";
        var detail_icon = "<?php echo e(asset('assets/media/icons/detail.png')); ?>/";
        var geo_icon = "<?php echo e(asset('assets/media/icons/geo.png')); ?>/";
        var report_icon = "<?php echo e(asset('assets/media/icons/report.png')); ?>/";
        var battery_on_icon = "<?php echo e(asset('assets/images/battery_on_icon.png')); ?>";
        var battery_off_icon = "<?php echo e(asset('assets/images/battery_off_icon.png')); ?>";
        var engine_on_icon = "<?php echo e(asset('assets/images/engine_on_icon.png')); ?>";
        var engine_off_icon = "<?php echo e(asset('assets/images/engine_off_icon.png')); ?>";
        var fuel_on_icon = "<?php echo e(asset('assets/images/fuel_on_icon.png')); ?>";
        var fuel_off_icon = "<?php echo e(asset('assets/images/fuel_off_icon.png')); ?>";
        window.device_icon_container = '';
        ...
        function user_information(user_id) {
            $http.get('../devices/' + user_id).then(function(response) {
                $scope.all_devices = [];
        ...
        $scope.openMarkerByID = function(id) {
            ...
            load_spinner('show', 'show_small_loader', '');
            ...
            for (var i = 0; i < $scope.all_devices.length; i++) {
                if ($scope.all_devices[i].imei == id) {
                    ...
                    //map.fitBounds(polylinePoints[$scope.all_devices[i].imei]);
            ...
            $('#myLocation').html('<button type="button" class="btn load_geo_address" data-lat="' + $scope
                .selected_device.lat + '" data-lng="' + $scope.selected_device.lng +
                '" style="padding:0">Show Address</button>');
            load_spinner('hide', 'show_small_loader', '');
            move_speedometer();
        }
        var markerArray = [];
        var group;

        function move_speedometer() {
            if ($(".speedometer_class").hasClass('d-none')) {
                $(".speedometer_class").removeClass('d-none');
            }
            var speed_text = ' <span class="small" style="font-size: 50%;">km</span>';
            var mi = $scope.selected_device.speed;
            var miNum = parseFloat(mi);
            //make sure kmNum is a number then output
            if ((mi <= 75) && !isNaN(miNum)) {
                var speedMi = miNum * 2 - 31;
                $('#numbers').html(miNum.toFixed(1) + speed_text);
            } else if (!isNaN(miNum)) {
                var speedMi = 215;
                $('#numbers').html(miNum.toFixed(1) + speed_text);
            } else {
            ...
            var device_engine_status_icon;
            var device_battery_status_icon;
            var device_fuel_status_icon;
            var engine_icon_text;
            var battery_icon_text;
            var fuel_icon_text;
            if ($scope.selected_device.engine_on != undefined && $scope.selected_device.engine_on == 1) {
                device_engine_status_icon = engine_on_icon;
                engine_icon_text = '<div class="small icon_text">On</div>';
            } else {
                device_engine_status_icon = engine_off_icon;
                engine_icon_text = '<div class="small icon_text">Off</div>';
            }
            if ($scope.selected_device.battery_status != undefined && $scope.selected_device.battery_status ==
                1) {
                device_battery_status_icon = battery_on_icon;
                battery_icon_text = '<div class="small icon_text">' + $scope.selected_device.voltage +
                    'v</div>';
            } else {
                device_battery_status_icon = battery_off_icon;
                battery_icon_text = '<div class="small icon_text">12v</div>';
            }
            if ($scope.selected_device.battery_level != undefined && $scope.selected_device.battery_level ==
                6) {
                device_fuel_status_icon = fuel_on_icon;
                fuel_icon_text = '<div class="small icon_text">100%</div>';
            } else {
                device_fuel_status_icon = fuel_off_icon;
                fuel_icon_text = '<div class="small icon_text">na</div>';
            }

            device_icon_container = '<table><tr>';
            device_icon_container += '<td><img src="' + device_engine_status_icon +
                '" class="device_icon_image">' + engine_icon_text + '</td>';
            device_icon_container += '<td><img src="' + device_battery_status_icon +
                '" class="device_icon_image">' + battery_icon_text + '</td>';
            device_icon_container += '<td><img src="' + device_fuel_status_icon +
                '" class="device_icon_image">' + fuel_icon_text + '</td>';
            device_icon_container += '</tr></table>';
            $("#selected_icon_container").html(device_icon_container);
        }
        ...
        function load_map() {
            ...
            L.control.custom({
                    position: 'topright',
                    content: '<input type="hidden" name="miles" id="miles" /><input type="hidden" name="kilometers" id="kilometers" />' +
                        ...
                        '<div id="mi-km"></div>' +
                        '<div id="needle"></div>' +
                        '<div id="selected_icon_container"></div>' +
                        '</div>' +
                        '</div>',
                    classes: 'speedometer_class d-none',
                    style: {
                        margin: '12px',
                        padding: '0px 0 0 0',
                        cursor: 'pointer'
            ...
            if (devices.length > 0) {
                ...
                for (var x = 0; x < devices.length; x++) {
                    ...
                    infoWindow_content = "<h5 class='popover-header text-center'><strong>" + devices[x]
                        ...
                        geo_icon + '"/> </a>' +
                        '<a href="http://maps.google.com/maps?q=' + devices[x].lat + ',' + devices[x].lng +
                        '&amp;t=m' +
                        '" target="_blank" title="Street view"><i class="fa fa-street-view" style="font-size:17px; color:#FF9951;"> </i> </a>' +
                        '<a href="' + report_url + devices[x].imei + '_' + devices[x].device_name +
                        '" target="_blank"><img class="icon-img" title="Report" src="' + report_icon +
                        '"/> </a>' +
                        '</li>' +
                        '</ul>' +
        ...
        function position_markers(type = null) {
            $http.get('../devices/' + $scope.selected_user_details.id).then(function(response) {
                $scope.all_devices = [];
                $scope.online_devices = [];
                $scope.offline_devices = [];
                for (var i = 0; i < response.data.length; i++) {
                    ...
                    if ($scope.selected_device != undefined && $scope.selected_device.imei ==
                        ...
                        move_speedometer();
                        //map.fitBounds(polylinePoints[response.data[i].imei]);
                    }

                    if (polylinePoints[response.data[i].imei].length == 5) {
                        map.removeLayer(L.polyline(polylinePoints[response.data[i].imei], {}));
                        polylinePoints[response.data[i].imei].splice(0, 2);
                    ...
                    console.log(polylinePoints[response.data[i].imei].length);
                } //end of loop of all devices
        ...
        $scope.event_rel_data = function(imei) {
            console.log('Seleted imei is ' + imei);
            device_event_data(imei);
        }
        $scope.show_in_map = function(item) {
            ...
            var event_icon = L.icon({
                iconUrl: "<?php echo e(asset('assets/images/event_icon.png')); ?>",
                iconSize: [38, 38],
                iconAnchor: [20, 20],
                popupAnchor: [-2, -25]
            });
        ...
        $scope.go_driver_info = function() {
            ...
            var driverLink = encodeURIComponent(
                "<?php echo e(url('/dashboard/dashboard?type=vehicle_driver&page=driver&driver_id=')); ?>" + id);
        ...
        $scope.complain_data = function(id) {
            ...
            $.ajax({
                type: "GET",
                dataType: "html",
                url: "<?php echo e(url('dashboard/getComplainData')); ?>/" + id,
                success: function(response) {
        ...
        function device_event_data(imei) {
            $.ajax({
                type: "GET",
                dataType: "html",
                url: "<?php echo e(url('dashboard/getDeviceEventData')); ?>/" + imei,
                success: function(response) {

                    $('#load_device_event_data').html(response);
        ...
        function fuel_rel_data(id) {
            ...
            $.ajax({
                type: "GET",
                dataType: "html",
                url: "<?php echo e(url('dashboard/getFuelLogData')); ?>/" + id,
                success: function(response) {
                    if (response == 0) {
                        $('#add_fuel_button').attr('disabled', true);
                        $('#add_fuel_button').attr('title', 'Button disable for this device');
                        $('#load_fuel_log').html(
                            '<td colspan="3"><span class="text-danger m-3">No data found! Please assign this device in VMS.</span></td>'
                        );
                        load_spinner('hide', 'show_small_loader', '');
                    } else {
        ...
        function driver_data(id) {
            ...
            $.ajax({
                type: "GET",
                dataType: "json",
                url: "<?php echo e(url('dashboard/getDriverDataByImie')); ?>/" + id,
                success: function(response) {
                    console.log(response);
                    if (response == 0) {
                        $('.DriverDataPart').addClass('d-none');
                        ...
                        $('#driver_not_found').addClass('d-none');
                        var symble = "&";
                        var imgLink = "<?php echo e(asset('uploads/driver')); ?>/"
                        var driverLink =
                            "<?php echo e(url('/dashboard/dashboard?type=vehicle_driver&page=driver&driver_id=')); ?>"
        ...
        function driving_behaviour(imei, device_name) {
            ...
            // data_type = "json";
            // ajax_url = "<?php echo e(url('dashboard/getDrivingBehaviourByImie')); ?>";
            // post_data = {
            ...
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "<?php echo e(url('dashboard/showreport/drivingbehaviour/2')); ?>",
                data: {
                    device_list: imei_and_name,
                    from_monitor: true,
                    _token: "<?php echo e(csrf_token()); ?>",
        ...
        function expense_rel_data(id) {
            $.ajax({
                type: "GET",
                dataType: "html",
                url: "<?php echo e(url('dashboard/getExpenseLogData')); ?>/" + id,
                success: function(response) {
                    if (response == 0) {
        ...
        function doc_rel_data(id) {
            $.ajax({
                type: "GET",
                dataType: "html",
                url: "<?php echo e(url('dashboard/getDocTypeData')); ?>/" + id,
                success: function(response) {
                    if (response == 0) {
                        // $('#add_expense_button').attr('disabled', true);
                        // $('#add_expense_button').attr('title', 'Button disable for this device');
        ...
        function load_last_event() {
            $http.get('../lastEvent').then(function(response) {
                var eventList = response.data;
                for (var i = 0; i < response.data.length; i++) {
                    eventMsg('<a href="#" ng-click="show_in_map(' + response.data[i] + ')">' + response
                        .data[i].name + ' ' + response.data[i].event_desc + '</a>');
                }
            });
        }
        ...
        $scope.remove_node_selection = function() {
            $("#dealer_treeview").jstree().deselect_all(true);
            //$scope.selected_user_details.id = <?php echo $customer_id;?>;
            user_information(<?php echo $customer_id; ?>);
        ...
        $scope.show_command_modal = function(id, model_id, device_name = null) {
            ...
            $http.get("<?php echo e(url('devicecommand')); ?>/" + model_id).then(function(res) {
        ...
        $scope.show_event_list = function() {
            load_spinner('show', 'show_loader', '');
            $http.get("<?php echo e(url('dashboard/getEventList')); ?>/" + <?php echo $customer_id; ?>).then(function(
                response) {
        ...
        $scope.show_geofence_list = function() {
            load_spinner('show', 'show_loader', '');
            $http.get("<?php echo e(url('dashboard/getGeofenceList')); ?>/" + <?php echo $customer_id; ?>).then(
                function(response) {
        ...
        $scope.go_to_geofence = function() {
            //window.location.href="<?php echo e(url('dashboard/geofence')); ?>";
            window.open("<?php echo e(url('dashboard/geofence')); ?>", '_blank');
        }

        $("body").on('click', '.load_geo_address', function() {
            var address_div = $(this).parent();
            address_div.html('Loading...');
            $.get("<?php echo e(url('dashboard/findAddress')); ?>/" + $(this).data('lat') + "/" + $(this).data('lng'))
                .done(function(res) {
    ...
    function edit_device(id) {
        $.ajax({
            type: "GET",
            dataType: "json",
            url: "<?php echo e(url('dashboard/getImei')); ?>/" + id,
            success: function(response) {
                tu_status_log_datatable(id);
                $("#singleDeviceInfo").click();
                console.log(response);
                ...
                $("#edit_fuel_consumption_value").val(response.fuel_consumption);
                $("#edit_ave_fuel_price").val(response.average_fuel_price);
    ...
    function tu_status_log_datatable(id) {
        var table = $('#single_tu_status_log_table').DataTable({
            ...
            ajax: {
                type: "GET",
                url: "<?php echo e(url('dashboard/single_tu_status_log')); ?>/" + id,
                data: function(d) {
    ...
    function save_imei() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(url('dashboard/saveImei')); ?>",
            data: {
                'id': updated_id,
                ...
                'average_fuel_price': $("#edit_ave_fuel_price").val(),
                'fuel_consumption': $("#edit_fuel_consumption_value").val(),
                _token: "<?php echo e(csrf_token()); ?>",
                _method: "POST"
            },
            success: function(response) {
    ...
    <script src="<?php echo e(asset('assets/js/CSSPlugin.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/TweenLite.min.js')); ?>"></script>
    <script>
    /*  for speedometer function */
    ...
    $('#saveCommandForm').submit(function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(url('dashboard/saveCommand')); ?>",
            data: {
                'name': $("#command_name_label").text(),
                'imei': angular.element(document.getElementById('monitor_body')).scope().selected_device
                    .imei,
            ...
            success: function(response) {
                if (response == 1) {
                    $('#command_response').text($("#command_name_label").text() +
                        " command sent successfully");
                    $('#responseModal').modal('show');
                    $('#saveCommandForm')[0].reset();
                } else {
                    errorMsg();
                }
    ...
    $(document).on('submit', 'form#saveComplainForm', function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(url('dashboard/saveComplain')); ?>/" + id,
    ...
    $(document).on('submit', 'form#saveFuelLogForm', function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(url('dashboard/saveFuelByObject')); ?>/" + id,
    ...
    $(document).on('submit', 'form#saveExpenseLogForm', function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(url('dashboard/saveExpenseByObject')); ?>/" + id,
...
</html><?php /**PATH C:\xampp\htdocs\angular\resources\views/enduser/monitor/v1/customer_monitor.blade.php ENDPATH**/ ?>